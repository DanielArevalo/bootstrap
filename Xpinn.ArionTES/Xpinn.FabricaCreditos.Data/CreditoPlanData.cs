                ...
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        while (resultado.Read())
                        {
                            ...
                            if (resultado["MONTO_APROBADO"] != DBNull.Value) entidad.MontoApr = Convert.ToInt64(resultado["MONTO_APROBADO"]);
                    ...
                    try
                    {
                        ...
                        if (resultado.Read())
                        {
                            ...
                            if (bTasa == true)
                            {
                                ...
                                entidad.TasaInteres = pTASA.Value != null ? (pTASA.Value.ToString() != "" ? Convert.ToDouble(pTASA.Value) : 0) : 0;
                                entidad.TasaEfe = pTASAEFE.Value != null ? Convert.ToDouble(pTASAEFE.Value) : 0;
                                entidad.TasaNom = pTASANOM.Value != null ? Convert.ToDouble(pTASANOM.Value) : 0;
                            }
