...
namespace Xpinn.NIIF.Data
{
    ...
    /// </summary>    
    public class SituacionFinancieraData : GlobalData
    {
        ...
        /// </summary>
        public SituacionFinancieraData()
        {
        ...
        public List<SituacionFinanciera>ListarSituacionFinanciera(SituacionFinanciera pEntidad, Usuario vUsuario, int pOpcion)
        {
            ...
            List<SituacionFinanciera> lstBalancecomparativo= new List<SituacionFinanciera>();
            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(vUsuario))
              {
                ...
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        cmdTransaccionFactory.CommandText = "USP_XPINN_NIIF_SITU_FINANCIERA";
                        cmdTransaccionFactory.ExecuteNonQuery();
                    }
                    catch (Exception ex)
                    {
                        BOExcepcion.Throw("SituacionFinancieraData", "USP_XPINN_NIIF_SITU_FINANCIERA", ex);
                        return null;
                    }
                };
                ...
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        {
                            SituacionFinanciera entidad = new SituacionFinanciera();
                    ...
                    {
                        BOExcepcion.Throw("SituacionFinancieraData", "ListarSituacionFinanciera", ex);
                        return null;
                    }
                }
            }
        ...
        {
            DbDataReader resultado = default(DbDataReader);
            List<SituacionFinanciera> lstFecha1 = new List<SituacionFinanciera>();
            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(pUsuario))
            {
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    ...
                    {
                        BOExcepcion.Throw("SituacionFinancieraData", "ListarFecha1", ex);
                        return null;
                    }
                }
            }
