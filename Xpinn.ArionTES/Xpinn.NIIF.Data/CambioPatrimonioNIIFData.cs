...
namespace Xpinn.NIIF.Data
{
    ...
    public class CambioPatrimonioNIIFData : GlobalData
    {
        protected ConnectionDataBase dbConnectionFactory;
        public CambioPatrimonioNIIFData()
        {
       ...
       public List<CambioPatrimonioNIIF>ListarEstadoCambioPatrimonio(CambioPatrimonioNIIF pEntidad, Usuario vUsuario, int pOpcion)
        {
            ...
            List<CambioPatrimonioNIIF> lstBalancecomparativo= new List<CambioPatrimonioNIIF>();
            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(vUsuario))
              {
                ...
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        cmdTransaccionFactory.CommandType = CommandType.StoredProcedure;
                         ...
                         cmdTransaccionFactory.CommandText = "USP_XPINN_NIIF_EST_CAMB_PATRI";
                        cmdTransaccionFactory.ExecuteNonQuery();
                    }
                    catch (Exception ex)
                    {
                        BOExcepcion.Throw("CambioPatrimonioNIIFData", "USP_XPINN_NIIF_EST_CAMB_PATRI", ex);
                        return null;
                    }
                };
                ...
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        {
                            CambioPatrimonioNIIF entidad = new CambioPatrimonioNIIF();
                    ...
                    {
                        BOExcepcion.Throw("CambioPatrimonioNIIFData", "ListarEstadoCambioPatrimonio", ex);
                        return null;
                    }
                }
            }
        ...
        {
            DbDataReader resultado = default(DbDataReader);
            List<CambioPatrimonioNIIF> lstFecha1 = new List<CambioPatrimonioNIIF>();
            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(pUsuario))
            {
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    ...
                    {
                        BOExcepcion.Throw("CambioPatrimonioNIIFData", "ListarFecha1", ex);
                        return null;
                    }
                }
            }
