<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Factura.aspx.cs" Inherits="Factura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div id="DivFactura" runat="server">
        <table style="width: 300px; font-family:'Courier New'; font-size:smaller; ">
            <tr>
                <td rowspan="1" class="align-rt" style="width: 66px; height: 10px;">&nbsp;
                    <asp:Image ID="imgLogo" runat="server" Height="53px" ImageUrl="~/Images/LogoEmpresa.jpg" Width="55px" />
                </td>
        ...
        <table style="width: 250px; margin-left: 25px; font-family:'Courier New'; font-size:smaller;">
            ...
            <tr>
                <td align="left" style="font-family: Times New Roman" colspan="3">
                ...
                <td colspan="2">
                    <asp:GridView ID="gvSaldos" runat="server" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="nro_producto" HeaderText="Nro Ref" />
                            <asp:BoundField DataField="saldo" HeaderText="Valor" DataFormatString="{0:N0}">
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                        </Columns>
                        <FooterStyle BackColor="#CCCC99" />
    ...
    <div id="DivReporte" runat="server">
        <table style="width: 205px">
            <tr>
                <td>
                    <rsweb:ReportViewer ID="Rpview" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        Height="300px" InteractiveDeviceInfos="(Colección)" WaitMessageFont-Names="Verdana"
                        WaitMessageFont-Size="14pt" Width="200px" ShowBackButton="False"
                        ...
                        <LocalReport ReportPath="Page\CajaFin\OperacionCaja\Factura.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <iframe id="frmPrint" name="IframeName" src="../../Reportes/Reporte.aspx"
                                runat="server" style="position: relative; display: block; top: -100000px"></iframe>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
