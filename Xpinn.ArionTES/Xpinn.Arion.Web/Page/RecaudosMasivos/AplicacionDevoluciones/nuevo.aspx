...
<%@ Register Src="~/General/Controles/ctlNumero.ascx" TagName="numero" TagPrefix="uc1" %>
    ...
    <asp:Panel ID="panelGeneral" runat="server">
        <asp:Panel ID="panelEncabezado" runat="server">
            ...
            <table width="80%">
                <tr>
                    <td>
                        <div id="divDatos" runat="server" style="overflow: scroll; max-height: 135px">
                            ...
                            <asp:GridView ID="gvServicios" runat="server" Width="100%" GridLines="Horizontal" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="valor_cuota" HeaderText="Valor" DataFormatString="{0:n0}" />
                                </Columns>
                                <HeaderStyle CssClass="gridHeader"></HeaderStyle>
                                <PagerStyle CssClass="gridPager"></PagerStyle>
                                <RowStyle CssClass="gridItem"></RowStyle>
                    ...
                    <tr>
                        <td style="text-align: left;" colspan="2">
                            <asp:Panel ID="pnlFormaPago" runat="server">
                                <strong style="text-align: left"><span>Listado de Devoluciones</span></strong>
                                <asp:GridView ID="gvDevoluciones" runat="server" Width="80%"
                                    GridLines="Horizontal" AutoGenerateColumns="False"
                                    AllowPaging="True" PageSize="20" DataKeyNames="num_devolucion"
                                    Font-Size="Small" OnRowDataBound="gvDevoluciones_RowDataBound">
                                    <Columns>
                                        <%--<asp:CommandField ButtonType="Image" EditImageUrl="~/Images/gr_edit.jpg" ShowEditButton="True" />--%>
                                        ...
                                        <asp:TemplateField HeaderText="Valor a Aplicar">
                                            <ItemTemplate>
                                                <uc1:decimalesGridRow ID="txtValorDevolucion" runat="server" CssClass="textbox" Width_="80"
                                ...
                                <table style="width: 80%;" cellpadding="2" cellspacing="0">
                                    <tr>
                                        <td style="text-align: left; width: 150px">Valor Devoluciones
                                        </td>
                                        <td style="text-align: left; width: 120px">
                                            <asp:TextBox ID="txtValTotalDevolucion" runat="server" CssClass="textbox" Enabled="false" Width="120px" Style="text-align: right"></asp:TextBox>
                                            <asp:MaskedEditExtender ID="meeTotalDevol" runat="server" TargetControlID="txtValTotalDevolucion" Mask="999,999,999,999,999" MessageValidatorTip="true"
                                                OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" MaskType="Number" InputDirection="RightToLeft"
                                                AcceptNegative="Left" DisplayMoney="Left" ErrorTooltipEnabled="True">
                                            </asp:MaskedEditExtender>
                                        </td>
