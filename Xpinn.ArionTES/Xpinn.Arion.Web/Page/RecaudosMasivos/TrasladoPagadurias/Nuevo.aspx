        ...
        $(document).ready(function ()
        {
            $("#btn_actualizar").click(function () {
                ...
                $("#gvProductos > tbody > tr ").each(function (i, val)
                {
                    ...
                    if (col>1)
                    {
                        var caja = $("#ddlFormaPago")[0].selectedIndex;
                        this.children[3].children[0].selectedIndex = caja;
                        this.children[4].children[0].selectedIndex = 0;
                        if (caja==1)
                        {
                            var empresa = $("#ddlEmpresa")[0].selectedIndex;
                            this.children[4].children[0].selectedIndex = empresa;
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 606px">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 170px">
                                Forma de Pago<br />
                                                    <asp:DropDownList ID="ddlFormaPago" ClientIDMode="Static" OnSelectedIndexChanged="ddlFormaPago_SelectedIndexChanged" runat="server" Width="95%" CssClass="textbox"
                                                        AutoPostBack="True" >
                             ...
                             <td style="text-align: left;">
                                 <asp:Panel ID="pEmpresa" runat="server">
                                 <asp:Label ID="lblEmpresa" runat="server" Text="Empresa" /><br />
                                                    <asp:DropDownList ID="ddlEmpresa" ClientIDMode="Static" runat="server" Width="180px" CssClass="textbox" >
                                                    </asp:DropDownList>
                                     </asp:Panel>
                            </td>
                            <td style="text-align:left;">
                                <input type="button" value="Actualizar" ID="btn_actualizar" />
                            <%--<asp:Button Text="Actualizar" ID="btn_actualizar" ClientIDMode="Static" runat="server" AutoPostBack="False"  />
                            --%></td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <asp:GridView ID="gvProductos" ClientIDMode="Static" runat="server" Width="100%" AutoGenerateColumns="False"
                           ...
                           OnRowDataBound="gvProductos_RowDataBound"  Style="font-size: x-small">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="gridIco" HeaderText="Forma Pago">
                                    <ItemTemplate>
                                       <asp:DropDownList ID="ddlFormaPagoPro" ClientIDMode="Static" runat="server" Width="100px" CssClass="textbox">
                                                        <asp:ListItem Value="1">Caja</asp:ListItem>
                                                        <asp:ListItem Value="2">Nomina</asp:ListItem>
                                       </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-CssClass="gridIco" HeaderText="Empresa">
                                    <ItemTemplate>
                                       <asp:DropDownList ID="ddlEmpresaPro" ClientIDMode="Static" runat="server" Width="180px" CssClass="textbox">
                                       </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderStyle-CssClass="gridIco" HeaderText="Procentaje">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtporcentaje" MaxLength="3" runat="server" />
