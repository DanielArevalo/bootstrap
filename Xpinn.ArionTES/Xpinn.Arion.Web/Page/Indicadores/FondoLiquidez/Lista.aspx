        ...
        <table>
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" AutoSizeColumnsMode="false" GridLines="Horizontal"  
                        ...
                        <Columns>
                            <asp:BoundField DataField="descripcion" HeaderText="Tipo Deposito">
                             ...
                             <asp:BoundField DataField="cod_cuenta" HeaderText="Cuenta" Visible="False">                          
                    ...
                    <asp:GridView ID="gvDatos0" runat="server" AutoGenerateColumns="False" AutoSizeColumnsMode="false" GridLines="Horizontal" HorizontalAlign="Center" OnRowDataBound="gvDatos_RowDataBound" PageSize="6" ShowFooter="True" Width="120%">
                        <Columns>
                            <asp:BoundField DataField="descripcion" HeaderText="Cuenta">
                            <ItemStyle HorizontalAlign="left" Width="74%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="cod_cuenta" HeaderText="Cuenta" Visible="False">
                            <ItemStyle HorizontalAlign="left" Width="20%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="total" DataFormatString="{0:n0}" HeaderText="Saldo">
