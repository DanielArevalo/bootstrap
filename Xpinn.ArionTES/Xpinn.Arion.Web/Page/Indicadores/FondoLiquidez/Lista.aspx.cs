...
partial class Nuevo : GlobalWeb
{
    ...
    protected void btnInforme_Click(object sender, EventArgs e)
    {
        ...
        List<IndicadoresLiquidez> LstDetalleComprobanted = new List<IndicadoresLiquidez>();    
        ...
        {
            LstDetalleComprobanted = IndicadoresLiquidezService.consultarDisponible(fechaInicial, (Usuario)Session["Usuario"]);
        }

        if (LstDetalleComprobanted.Count() > 0)
        {
            gvDatos.Visible = false;
            gvDatos0.Visible = true;
            gvDatos0.DataSource = LstDetalleComprobanted;
            gvDatos0.DataBind();
    ...
    private Double porcentajeliquidez = 0;
    ...
    protected void gvFondo_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            porcentajeliquidez=(sumaLiquidez / sumadepositos);
            e.Row.Cells[2].Text = Convert.ToString(Math.Round(porcentajeliquidez,4)*100);
            e.Row.Cells[2].HorizontalAlign = HorizontalAlign.Right;
            e.Row.Font.Bold = true;
