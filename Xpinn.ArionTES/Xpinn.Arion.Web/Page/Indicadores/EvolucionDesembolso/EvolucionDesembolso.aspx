<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="EvolucionDesembolso.aspx.cs" Inherits="Nuevo" %>
                ...
                <td>
                    <asp:Chart ID="Chart1" runat="server" BackColor="42, 58, 87" BackGradientStyle="TopBottom"                     
                        ...
                        <Series>
                            ...
                            <asp:Series ChartArea="ChartArea1" ChartType="Line" Legend="Default" MarkerBorderColor="Yellow" MarkerColor="Yellow" MarkerStyle="Circle" Name="Series5">
                            </asp:Series>
                        </Series>
                        <Legends>
                ...
                <td>
                    ...
                    <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" GridLines="Both" HeaderStyle-CssClass="gridHeader" Height="122px" PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem" ShowFooter="False" style="font-size:xx-small" Width="500px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="total_desembolsos" DataFormatString="{0:C}" HeaderText="Total Desembolsos">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="total_desembolsos_microcredito" DataFormatString="{0:C}" HeaderText="Total Desembolsos Microcredito">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="total_desembolsos_consumo" DataFormatString="{0:C}" HeaderText="Total Desembolsos Consumo">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="total_desembolsos_comercial" DataFormatString="{0:C}" HeaderText="Total Desembolsos Comercial">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="total_desembolsos_vivienda" DataFormatString="{0:C}" HeaderText="Total Desembolsos Vivienda">
                ...
                <td>
                    ...
                    <asp:GridView ID="gvCantidad" runat="server" AutoGenerateColumns="False" GridLines="Both" HeaderStyle-CssClass="gridHeader" Height="122px" PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem" ShowFooter="False" style="font-size:xx-small" Width="510px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="numero_desembolsos" HeaderText="Cantidad Desembolsos">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="numero_desembolsos_microcredito" HeaderText="Cantidad Desembolsos Microcredito">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="numero_desembolsos_consumo" HeaderText="Cantidad Desembolsos Consumo">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="numero_desembolsos_comercial" HeaderText="Cantidad Desembolsos Comercial">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="numero_desembolsos_vivienda" HeaderText="Cantidad Desembolsos Vivienda">
                            <ItemStyle width="85px" />
                            </asp:BoundField>
                        </Columns>
                        <HeaderStyle CssClass="gridHeader" />
