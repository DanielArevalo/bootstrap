<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="IndicadorCartera.aspx.cs" Inherits="Nuevo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td  style="text-align: center; width: 809px;">
                Vencimiento<br />
                <asp:CheckBox ID="chk30dias" runat="server" 
                    oncheckedchanged="chkdias_CheckedChanged" Text="> a 30 Dias" 
                    AutoPostBack="True" style="font-size: x-small" /> 
                <asp:CheckBox ID="chk60dias" runat="server" 
                    oncheckedchanged="chkdias_CheckedChanged" Text="> a 60 Dias" 
                    AutoPostBack="True" style="font-size: x-small" />                         
                <asp:CheckBox ID="chk90dias" runat="server" 
                    oncheckedchanged="chkdias_CheckedChanged" Text="> a 90 Dias" 
                    AutoPostBack="True" style="font-size: x-small" />                         
                <asp:CheckBox ID="chk120dias" runat="server" 
                    oncheckedchanged="chkdias_CheckedChanged" Text="> a 120 Dias" 
                    AutoPostBack="True" style="font-size: x-small" />  
                <asp:CheckBox ID="chk180dias" runat="server" 
                    oncheckedchanged="chkdias_CheckedChanged" Text="> a 180 Dias" 
                    AutoPostBack="True" style="font-size: x-small" />
                <asp:CheckBox ID="chk360dias" runat="server" 
                    oncheckedchanged="chkdias_CheckedChanged" Text="> a 360 Dias" 
                    AutoPostBack="True" style="font-size: x-small" />                                              
                <br />
            </td>
            ...
            <td style="text-align: left; width: 376px;">      
                    ...
                    <asp:Chart ID="Chart1"  runat="server" BackColor="42, 58, 87" BackGradientStyle="TopBottom"
                        ...
                        <Series>
                            <asp:Series Name="Series1" ChartType="Line" Color="#990000" 
                                Font="Microsoft Sans Serif, 6pt"  MarkerSize="7" MarkerBorderColor="Crimson" MarkerBorderWidth="1" MarkerColor="Crimson" MarkerStyle="Circle" >
                            </asp:Series>
                            ...
                            <asp:Series Name="Series3" ChartType="Line" Color="Yellow" 
                                ...
                                MarkerBorderColor="Crimson" MarkerBorderWidth="1" MarkerColor="Crimson" 
                                MarkerStyle="Circle" >
                            </asp:Series>
                            <asp:Series Name="Series4" ChartType="Line" Color="Green" 
                                Font="Microsoft Sans Serif, 6pt"  MarkerSize="7" 
                                MarkerBorderColor="Crimson" MarkerBorderWidth="1" MarkerColor="Crimson" 
                                MarkerStyle="Circle" >
                            </asp:Series>
                            <asp:Series Name="Series5" ChartType="Line" Color="192, 0, 192" 
                                Font="Microsoft Sans Serif, 6pt"  MarkerSize="7" 
                                MarkerBorderColor="Crimson" MarkerBorderWidth="1" MarkerColor="Crimson" 
                                MarkerStyle="Circle" >
                            </asp:Series>
                            <asp:Series Name="Series6" ChartType="Line" Color="255, 128, 128" 
                                Font="Microsoft Sans Serif, 6pt"  MarkerSize="7" 
                                MarkerBorderColor="Crimson" MarkerBorderWidth="1" MarkerColor="Crimson" 
                                MarkerStyle="Circle" >
                            </asp:Series>
