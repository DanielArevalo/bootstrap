<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="CarteraOficinas.aspx.cs" Inherits="Nuevo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <table style="width: 80%">
        ...
        <tr>
            ...
            <td  style="text-align: left">
                Generar Por:<br />
                <asp:DropDownList ID="ddlGeneracion" runat="server" Height="24px" 
                    Width="165px" onselectedindexchanged="ddlGeneracion_SelectedIndexChanged" 
                    AutoPostBack="True">
                    <asp:ListItem Value="1">Oficina</asp:ListItem>
                    <asp:ListItem Value="2">Línea de Crédito</asp:ListItem>
                    <asp:ListItem Value="3">Ejecutivo</asp:ListItem>
                    <asp:ListItem Value="4">Actividad</asp:ListItem>
                    <asp:ListItem Value="5">Clasificación</asp:ListItem>
                </asp:DropDownList>
            </td>
