...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                if (Session[ActivosFijoservicio.CodigoProgramaMantenimientoNif + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    {
        GuardarValoresConsulta(pConsulta, ActivosFijoservicio.CodigoProgramaMantenimientoNif);
        Actualizar();
    }

    protected void btnLimpiar_Click(object sender, ImageClickEventArgs e)
    {
        LimpiarValoresConsulta(pConsulta, ActivosFijoservicio.CodigoProgramaMantenimientoNif);
    }
    ...
    protected void gvLista_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(ActivosFijoservicio.CodigoProgramaMantenimientoNif + "L", "gvLista_RowDataBound", ex);
        }
    }
    ...
    protected void gvLista_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Session[ActivosFijoservicio.CodigoProgramaMantenimientoNif + ".id"] = id;
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(ActivosFijoservicio.CodigoProgramaMantenimientoNif, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    private void Actualizar()
    {
        try
        {
            ...
            Session.Add(ActivosFijoservicio.CodigoProgramaMantenimientoNif + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(ActivosFijoservicio.CodigoProgramaMantenimientoNif, "Actualizar", ex);
        }
    }
