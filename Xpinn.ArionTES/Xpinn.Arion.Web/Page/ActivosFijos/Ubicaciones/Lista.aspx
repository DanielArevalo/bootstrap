    ...
    <table border="0" cellpadding="0" cellspacing="0" width="70%">
        ...
        <tr>
            <td>
                ...
                HeaderStyle-CssClass="gridHeader" PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem"  DataKeyNames="cod_ubica" >
                    <Columns>
                        <asp:BoundField DataField="cod_ubica" HeaderStyle-CssClass="gridColNo" 
                        ...
                        <asp:BoundField DataField="cod_ubica" HeaderText="Código" >
