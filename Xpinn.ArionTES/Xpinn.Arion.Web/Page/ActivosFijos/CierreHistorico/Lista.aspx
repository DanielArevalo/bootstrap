...
<%@ Register Src="~/General/Controles/hora.ascx" TagName="hora" TagPrefix="uc1" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" style="width: 70%">
                    <br />
                    <asp:Label ID="Label2" runat="server" Text="Proceso de Cierre Histórico Terminado Correctamente"></asp:Label>
                    <br />
