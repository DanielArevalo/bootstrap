            ...
            <tr>
                <td>
                    <asp:GridView ID="gvLista" runat="server" Width="100%" GridLines="Horizontal" AutoGenerateColumns="False"
                        AllowPaging="True"  OnRowEditing="gvLista_RowEditing"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Gestionar">
                                <ItemTemplate>
                                <asp:ImageButton ID="btnInfo" runat="server" CommandName="Edit" ImageUrl="~/Images/gr_info.jpg" ToolTip="Detalle" Width="16px" />
                                </ItemTemplate>
                            </asp:TemplateField>
