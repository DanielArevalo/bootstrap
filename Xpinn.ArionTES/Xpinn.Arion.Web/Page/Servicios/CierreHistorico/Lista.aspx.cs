...
public partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(ServiciosServicio.CodigoPrograma, "L");
        ...
        {
            BOexcepcion.Throw(ServiciosServicio.GetType().Name + "L", "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Label2.Visible = true;
                Label2.Text = Convert.ToString(Session["MensajeServicios"]);
        ...
        {
            BOexcepcion.Throw(ServiciosServicio.GetType().Name + "L", "Page_Load", ex);
        }
    }
    ...
    protected void LlenarCombos()
    {
        ...
        lstFechaCierre = ServiciosServicio.ListarFechaCierre((Usuario)Session["Usuario"]);
    ...
    public void TerminarProceso()
    {
        ...
        Label2.Text = Session["MensajeServicios"].ToString();
    }
    ...
    public void EjecutaProceso()
    {
...

        {
            ...
            Xpinn.Servicios.Services.CierreHistorioService ServiciosServicio = new Xpinn.Servicios.Services.CierreHistorioService();
            Xpinn.Servicios.Entities.CierreHistorico servicios = new Xpinn.Servicios.Entities.CierreHistorico();
            ServiciosServicio.CierreHistorico(servicios, estado, fecha, codusuario, ref sError, (Usuario)Session["usuario"]);
            Session["MensajeServicios"] = "Cierre Mensual Terminado Correctamente";
        ...
        catch (Exception ex)
        {
            ...
            if (n > 0)
            {
                ...
                Session["MensajeServicios"] = lblError.Text;
                Label2.Visible = true;
                Label2.Text = Convert.ToString(Session["MensajeServicios"]);
                Session["Proceso"] = "FINAL";
            }
