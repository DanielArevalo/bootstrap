            ...
            <table style="text-align: center" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="text-align: left" colspan="5">
                        <strong>Datos de la Exclusión</strong>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left; width: 150px">
                        Fecha<br />
                        <ucFecha:fecha ID="txtFechaExclusion" runat="server" CssClass="textbox" />
                    </td>
                    <td style="text-align: left; width: 140px">
                        Valor a Excluir<br />
                        <uc1:decimales ID="txtValorExcluir" runat="server" CssClass="textbox" Width="90%"
                            Enabled="false" />
                    </td>
                    <td style="text-align: left; width: 140px">
                        Cuotas No Excluir<br />
                        <asp:TextBox ID="txtCuotasNoExclu" runat="server" CssClass="textbox" Style="text-align: right"
                            Width="70px" OnTextChanged="txtCuotasNoExclu_TextChanged" AutoPostBack="true" />
                        <asp:FilteredTextBoxExtender ID="fteCuotas" runat="server" TargetControlID="txtCuotasNoExclu"
                            FilterType="Custom, Numbers" ValidChars="+-=/*().," />
                    </td>
                    <td style="text-align: left; width: 320px" colspan="2" rowspan="2">
                        Motivo Exclusión<br />
                        <asp:DropDownList ID="ddlMotivoExclu" runat="server" CssClass="textbox" Width="90%" />
                    </td>
                </tr>
            </table>
        </asp:View>
