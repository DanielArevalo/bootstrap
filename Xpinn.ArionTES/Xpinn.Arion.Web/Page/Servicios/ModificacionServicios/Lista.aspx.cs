...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(AproServicios.CodigoProgramaModifi, "L");
        ...
        {
            BOexcepcion.Throw(AproServicios.CodigoProgramaModifi, "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AproServicios.CodigoProgramaModifi, "Page_Load", ex);
        }
    }

    protected void btnLimpiar_Click(object sender, ImageClickEventArgs e)
    {
        LimpiarValoresConsulta(pConsulta, AproServicios.CodigoProgramaModifi);
        txtFecha.Text = "";
        Actualizar();
    }
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AproServicios.CodigoProgramaModifi, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    protected void gvLista_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Session[AproServicios.CodigoProgramaModifi + ".id"] = id;
    ...
    private void Actualizar()
    {
        try
        {
            ...
            Session.Add(AproServicios.CodigoProgramaModifi + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(AproServicios.CodigoProgramaModifi, "Actualizar", ex);
        }
    }
