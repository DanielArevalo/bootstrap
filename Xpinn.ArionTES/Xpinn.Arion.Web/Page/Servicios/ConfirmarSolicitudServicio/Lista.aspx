    ...
    <asp:MultiView ID="mvPrincipal" runat="server" ActiveViewIndex="0">
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvLista" runat="server" Width="100%" GridLines="Horizontal" AutoGenerateColumns="False"
                                ...
                                RowStyle-CssClass="gridItem" DataKeyNames="numero_servicio" OnSelectedIndexChanged="gvLista_SelectedIndexChanged"
                                OnRowEditing="gvLista_RowEditing">
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" Visible='<%# Eval("descripcion_estado").ToString().Trim() != "Solicitado" ? false:true %>' ID="imgRechazar" CommandName="Edit" ImageUrl="~/Images/gr_elim.jpg" />                                                    
                                    </ItemTemplate>
                                </asp:TemplateField>                                                                
                                <asp:TemplateField HeaderStyle-CssClass="gridIco">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnInfo" runat="server" CommandName="Select" ImageUrl="~/Images/gr_info.jpg" Visible='<%# Eval("descripcion_estado").ToString().Trim() != "Solicitado" ? false:true %>'
                                            ToolTip="Confirmación de producto" Width="16px" />
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="gridIco"></HeaderStyle>
                                </asp:TemplateField>   
                                    <asp:BoundField HeaderText="Id solicitud" DataField="numero_servicio" />
                                    <asp:BoundField HeaderText="Cod. Persona" DataField="cod_persona" />
                                    <asp:BoundField HeaderText="Fec. solicitud" DataField="fechacreacion" DataFormatString="{0:d}">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Fec. servicio" DataField="fecha_solicitud" DataFormatString="{0:d}">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Producto" DataField="nom_linea" />
                                    <asp:BoundField HeaderText="Identificación" DataField="identificacion" />
                                    <asp:BoundField HeaderText="Nombre" DataField="nombre_titular" />
                                    <asp:BoundField HeaderText="Valor" DataField="valor_total" DataFormatString="${0:#,##0.00}"/>                                                                                                                                                                                                                          
                                    <asp:BoundField HeaderText="Observación" DataField="observaciones" />                                    
                                    <asp:BoundField HeaderText="Estado Solicitud" DataField="descripcion_estado">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
        ...
        <asp:View ID="mvFinal" runat="server">
            <table style="width: 100%; text-align: center">
                ...
                <tr>
                    <td style="text-align: center; font-size: large;">
                        <asp:Label ID="lblMensajeGrabar" runat="server" Text="Registro modificados correctamente"></asp:Label><br />
