        ...
        <table>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    <asp:DropDownList ID="ddlLinea" runat="server" CssClass="textbox" Width="140px" />
                </td>
                <td style="text-align: left;">
                    Identificación<br />
                ...
                <td style="text-align: left;">
                    Nombre<br />
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="textbox" Width="140px" />
                </td>
                 <td style="text-align: left;">
                    Oficina<br />
                    <asp:DropDownList ID="ddlOficina" runat="server" CssClass="textbox" Width="100px" />
                </td>
                <td style="text-align: left;">
                    Código de nómina<br />
