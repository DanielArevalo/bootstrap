...
public partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(cuentasProgramado.CodigoProgramaTraslado, "L");
    ...
    {
        LimpiarValoresConsulta(pConsulta, cuentasProgramado.CodigoProgramaTraslado);
    ...
    private void Actualizar()
    {
        ...
        try
        {
            ...
            Session.Add(cuentasProgramado.CodigoProgramaTraslado + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(cuentasProgramado.CodigoProgramaTraslado, "Actualizar", ex);
        }
    }
    ...
    void cargarListaddl()
    {
        ...
        poblar.PoblarListaDesplegable("lineaprogramado", ddlLinea, (Usuario)Session["usuario"]);
    }
