                ...
                <td style="text-align: left">
                    <asp:GridView ID="gvLista" runat="server" Width="100%" PageSize="15" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Oficina" HeaderText="Tipo Oficina" HeaderStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="Motivo_Apertura" HeaderText="Motivo Apertura" HeaderStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="Fecha_Proximo_Pago" HeaderText="Fecha Proximo Pago"  DataFormatString="{0:d}" HeaderStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
