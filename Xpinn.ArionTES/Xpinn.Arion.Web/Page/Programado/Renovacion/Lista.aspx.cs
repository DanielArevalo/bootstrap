...
public partial class Lista : GlobalWeb
{
    ...
    {
        LimpiarValoresConsulta(pConsulta, cuentasProgramado.CodigoProgramaRenovacion);
    ...
    private void Actualizar()
    {
        ...
        try
        {
            ...
            listaConsulta = new CuentasProgramadoServices().ListarRenovaciones(fechaApertura, filtro, (Usuario)Session["usuario"]);
            ...
            Session.Add(cuentasProgramado.CodigoProgramaRenovacion + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(cuentasProgramado.CodigoProgramaRenovacion, "Actualizar", ex);
        }
    }
