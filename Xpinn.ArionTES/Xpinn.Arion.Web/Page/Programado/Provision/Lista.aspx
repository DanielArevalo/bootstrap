        ...
        <table cellpadding="5" cellspacing="0" style="width: 80%; margin-right: 0px;">
            ...
            <tr>
                <td style="height: 15px; text-align: left; width: 150px;">
                    &nbsp;</td>
                <td style="height: 15px; text-align: left; width: 119px;">
                    <asp:DropDownList ID="ddlLineaProgramado" runat="server"
        ...
        <tr>
            <td>
                <asp:GridView ID="gvLista" runat="server" Width="80%" AutoGenerateColumns="False"
                    ...
                    OnRowDataBound="gvLista_RowDataBound" DataKeyNames="numero_programado" Style="font-size: xx-small">
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="gridIco">
                            <HeaderStyle CssClass="gridIco"></HeaderStyle>
                        </asp:TemplateField>
                        <asp:BoundField DataField="numero_programado" HeaderText="No.Cuenta">
                            <ItemStyle HorizontalAlign="Left" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="cod_linea_programado" HeaderText="Línea">
                        ...
                        <asp:BoundField DataField="tasa_interes" HeaderText="Tasa Interes" DataFormatString="{0:n0}">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
