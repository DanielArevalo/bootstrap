<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="Detalle.aspx.cs" Inherits="Detalle" Title=".: Xpinn - Desembolso Masivo :." %>
        ...
        <asp:View ID="vwData" runat="server">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        Periodicidad<br />
                        <asp:TextBox ID="txtPeriodicidad" runat="server" CssClass="textbox" Width="170px"
                            Enabled="false" />
                    </td>
                    <td style="text-align: left">
                        Cuota<br />
                ...
                <tr>
                    <td>
                        <rsweb:reportviewer id="rvReportMov" runat="server" font-names="Verdana" font-size="8pt"
                            ...
                            waitmessagefont-size="10pt" width="100%" Height="500px"><localreport reportpath="Page\Programado\MovimientoCuentas\rptMovimientoCuenta.rdlc"><datasources><rsweb:ReportDataSource /></datasources></localreport></rsweb:reportviewer>
                    </td>
                </tr>
            </table>
        </asp:View>
