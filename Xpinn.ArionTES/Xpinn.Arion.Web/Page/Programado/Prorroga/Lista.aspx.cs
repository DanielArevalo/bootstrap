...
public partial class Lista : GlobalWeb
{
    ...
    {
        LimpiarValoresConsulta(pConsulta, cuentasProgramado.CodigoProgramaProrrogaCuenta);
    ...
    private void Actualizar()
    {
        ...
        try
        {
            ...
            listaConsulta = new CuentasProgramadoServices().ListarProrrogas(fechaApertura, filtro, (Usuario)Session["usuario"]);
            ...
            Session.Add(cuentasProgramado.CodigoProgramaProrrogaCuenta + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(cuentasProgramado.CodigoProgramaProrrogaCuenta, "Actualizar", ex);
        }
    }
