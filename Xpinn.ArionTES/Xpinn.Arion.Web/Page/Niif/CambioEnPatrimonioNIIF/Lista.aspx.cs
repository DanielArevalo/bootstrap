...
{
    private Xpinn.NIIF.Services.CambioPatrimonioNIIFService CambioPatrimonioSer = new Xpinn.NIIF.Services.CambioPatrimonioNIIFService();
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                VisualizarOpciones(CambioPatrimonioSer.CodigoProgramaNIIF, "L");
                pCodigo = CambioPatrimonioSer.CodigoProgramaNIIF;
            }
    ...
    protected void LlenarCombos()
    {
        ...
        List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF> lstFechaCierre = new List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>();
        ...
        Xpinn.NIIF.Entities.CambioPatrimonioNIIF CambioPatrimonioNIIF= new Xpinn.NIIF.Entities.CambioPatrimonioNIIF();
        lstFechaCierre = CambioPatrimonioSer.ListarFecha((Usuario)Session["Usuario"]);
    ...
    {
        mvSituacionFinanciera.ActiveViewIndex = 0;
    ...
    private void Actualizar(String pIdObjeto)
    {
        ...
        try
        {
            ...
            Xpinn.NIIF.Entities.CambioPatrimonioNIIF datosApp = new Xpinn.NIIF.Entities.CambioPatrimonioNIIF();
            ...
            List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF> lstConsultaCambioPatrimonio = new List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>();
            lstConsultaCambioPatrimonio.Clear();
            int pOpcion = Request.QueryString["niif"] != null ? 2 : 1;
            lstConsultaCambioPatrimonio = CambioPatrimonioSer.ListarEstadoCambioPatrimonio(datosApp, (Usuario)Session["usuario"], pOpcion);
            
            gvLista.EmptyDataText = emptyQuery;
            Session["DTCAMBIOPATRIMONIO"] = lstConsultaCambioPatrimonio;

            gvLista.DataSource = lstConsultaCambioPatrimonio;
            if (lstConsultaCambioPatrimonio.Count > 0)
            {
                btnInforme.Visible = true;
                btnExportar.Visible = true;

                List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF> lstConsulta = new List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>();
                gvLista.Visible = true;
                int indice = 0;
                Int64? nivel = null;
                foreach (Xpinn.NIIF.Entities.CambioPatrimonioNIIF item in lstConsultaCambioPatrimonio)
                {
                    Xpinn.NIIF.Entities.CambioPatrimonioNIIF rNuevo1 = new Xpinn.NIIF.Entities.CambioPatrimonioNIIF();
                    ...
                    if (nivel != null)
                    {
                        if (nivel != item.nivel)
                        {
                            if (item.nivel <= 2)
                            {
                                Xpinn.NIIF.Entities.CambioPatrimonioNIIF rNuevo = new Xpinn.NIIF.Entities.CambioPatrimonioNIIF();
                                if (item.balance1 > 0)
                ...
                mvSituacionFinanciera.ActiveViewIndex = 0;
                gvLista.Columns[2].HeaderText = "SALDOS A "+ datosApp.fechasegunper.ToShortDateString();
                gvLista.Columns[3].HeaderText = "DISTRIBUCION EXCEDENTES "+ datosApp.fechasegunper.ToShortDateString();
                gvLista.Columns[4].HeaderText = "DISMINUCIONES DEL " + datosApp.fechasegunper.ToShortDateString();
                gvLista.Columns[5].HeaderText = "AUMENTOS DEL " + datosApp.fechaprimerper.ToShortDateString();
                gvLista.Columns[6].HeaderText = "SALDOS A " +  datosApp.fechaprimerper.ToShortDateString();
                Session["DTCAMBIOPATRIMONIO"] = lstConsulta;
            ...
            else
            {
                btnInforme.Visible = false;
                btnExportar.Visible = false;
                mvSituacionFinanciera.ActiveViewIndex = -1;
            }
    ...
    public DataTable CrearDataTableCambioPatrimonio()
    {

        List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF> lstCambioPatrimonio= new List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>();
        lstCambioPatrimonio = (List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>)Session["DTCAMBIOPATRIMONIO"];
        ...
        foreach (Xpinn.NIIF.Entities.CambioPatrimonioNIIF item in lstCambioPatrimonio)
        {
            ...
            if (item.diferencia2 != 0)
                datarw[3] = item.diferencia2.ToString("##,##0");
            else
               datarw[3] = "".ToString();


            if (item.diferencia != 0)
                datarw[4] = item.diferencia.ToString("##,##0");
            else
               datarw[4] = "".ToString();
            ...
            if (item.balance2 != 0)
                datarw[5] = item.balance2.ToString("##,##0");
            else
                datarw[5] = "".ToString();
    ...
    protected void btnInforme_Click(object sender, EventArgs e)
    {
        ...
        VerError("");
        if (Session["DTCAMBIOPATRIMONIO"] == null)
        {
        ...
        if (Session["DTCAMBIOPATRIMONIO"] != null)
        {
            ...
            List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF> lstBalanceGenComp = new List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>();
            lstBalanceGenComp = (List<Xpinn.NIIF.Entities.CambioPatrimonioNIIF>)Session["DTCAMBIOPATRIMONIO"];
            ...
            mvSituacionFinanciera.Visible = true;
            ...
            ReportDataSource rds = new ReportDataSource("DataSetCambioPatrimonioNIIF", CrearDataTableCambioPatrimonio());
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        try
        {
            if (gvLista.Rows.Count > 0 && Session["DTCAMBIOPATRIMONIO"] != null)
            {
                ...
                gvLista.DataSource = Session["DTCAMBIOPATRIMONIO"];
                gvLista.DataBind();
    ...
    protected void gvLista_RowDataBound(object sender, GridViewRowEventArgs e)
    {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                String valor = Convert.ToString(e.Row.Cells[2].Text);
