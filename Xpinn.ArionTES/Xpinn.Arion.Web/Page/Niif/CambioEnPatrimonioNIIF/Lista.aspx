...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:MultiView ID="mvSituacionFinanciera" runat="server" ActiveViewIndex="0">
            ...
            <asp:Panel ID="pConsulta" runat="server">
                <table id="tbCriterios" border="0" cellpadding="0" cellspacing="0" style="width: 68%">
                    ...
                    <tr>
                        ...
                        <td class="tdD" style="text-align:left">
                            <asp:DropDownList ID="ddlNivel0" runat="server" Visible="FALSE" CssClass="dropdown" Height="30px" Width="113px">
                ...
                <tr>
                    <td>                                
                        <asp:GridView ID="gvLista" runat="server" 
                            ...
                            RowStyle-CssClass="gridItem" Width="1000px"                             
                            ...
                            <Columns>                        
                                ...
                                <asp:BoundField DataField="balance2" HeaderText="Balance 2" 
                                    DataFormatString="{0:c}" >
                                        <ItemStyle HorizontalAlign="Right" Width="150px" />
                                    </asp:BoundField>                                    
                                <asp:BoundField DataFormatString="{0:c}" HeaderText="DIS.EXC " VISIBLE="FALSE" >
                                <ItemStyle HorizontalAlign="Right" Width="50px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="diferencia2"  DataFormatString="{0:c}"  HeaderText="DISMINUCIONES DEL">
                                <ItemStyle HorizontalAlign="Right" Width="150px" />
                                </asp:BoundField>
                              
                                 <asp:BoundField DataField="diferencia"  DataFormatString="{0:c}"  HeaderText="AUMENTOS DE">
                                <ItemStyle HorizontalAlign="Right" Width="150px" />
                                </asp:BoundField>


                                <asp:BoundField DataField="balance1" HeaderText="Balance1" 
                                    DataFormatString="{0:c}">
                                    <ItemStyle HorizontalAlign="Right" Width="150px" />
                                    </asp:BoundField>
                            </Columns>
                ...
                <tr>
                    <td style="text-align: left">
                        <rsweb:ReportViewer ID="RptReporte" runat="server" Width="100%" Height="500px">
                            <LocalReport ReportPath="Page\NIIF\CambioEnPatrimonioNIIF\RptCambioEnPatrimonioNIIF.rdlc">
                            </LocalReport>
                        </rsweb:ReportViewer>
                    </td>
                </tr>
