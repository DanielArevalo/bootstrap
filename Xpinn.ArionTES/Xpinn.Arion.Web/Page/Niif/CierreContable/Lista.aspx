<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - Cierre Contable NIIF :." %>
                    ...
                    <tr>
                        ...
                        <td class="tdD" style="text-align:left;">
                            ...
                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" Width="188px" 
                                ...
                                <asp:ListItem Value="D" Selected="True">Definitivo</asp:ListItem>
                                <asp:ListItem Value="P" >Prueba</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td class="tdD" style="text-align: left;">
                            <br />                            
                            ...
                            <asp:GridView ID="gvLista" runat="server" 
                                ...
                                <Columns>                        
                                    ...
                                    <asp:TemplateField HeaderText="Seleccionar">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSeleccionarcentro" runat="server" Enabled="false" />
                                        </ItemTemplate>
