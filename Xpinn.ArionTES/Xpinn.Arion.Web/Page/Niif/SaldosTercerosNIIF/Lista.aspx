...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:MultiView ID="mvSaldosTer" runat="server" ActiveViewIndex="0">
                ...
                <tr>
                    <td>                        
                        <asp:GridView ID="gvLista" runat="server" 
                            ...
                            <Columns>                        
                                <asp:BoundField DataField="cod_cuenta" HeaderText="Cod.Cuenta NIIF" >
                                    <ItemStyle HorizontalAlign="Left" Width="50px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="nombrecuenta" HeaderText="Nom. Cuenta NIIF" >
                                ...
                                <asp:BoundField DataField="saldofinal" DataFormatString="{0:c2}" HeaderText="Saldo Final">
                                    <ItemStyle HorizontalAlign="Right" Width="120px" />
                                </asp:BoundField>
                            </Columns>
        ...
        <asp:View ID="vwReporte" runat="server">
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnImprime" runat="server" CssClass="btn8" Width="130px" OnClick="btnImprime_Click"
                Text="Imprimir" />
            <rsweb:ReportViewer ID="RptReporte" runat="server" Width="95%" Height="550px">
                <LocalReport ReportPath="Page\Niif\SaldosTercerosNIIF\rptSaldoTerceros.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
