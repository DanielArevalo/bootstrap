...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(SaldosTercerosSer.CodigoProgramaNIIF, "L");

            Site toolBar = (Site)this.Master;
            toolBar.eventoConsultar += btnConsultar_Click;
            toolBar.eventoLimpiar += btnLimpiar_Click;
            LimpiarValoresConsulta(pConsulta, SaldosTercerosSer.CodigoProgramaNIIF);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(SaldosTercerosSer.CodigoProgramaNIIF, "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(SaldosTercerosSer.CodigoProgramaNIIF, "Page_Load", ex);
        }
    }
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(SaldosTercerosSer.CodigoProgramaNIIF, "gvLista_PageIndexChanging", ex);
        }
    }
        ...
        else
        {
            ...
            try
            {
                ...
                if (chkConsolidado.Checked == true)
                {
                    ...
                    lstConsultasaldos = SaldosTercerosSer.ListarSaldoConsolidadoNIIF(datosApp, ref SalIni, ref TotDeb, ref TotCre, ref SalFin, (Usuario)Session["usuario"]);
                ...
                if (chkConsolidado.Checked == false)
                {
                    ...
                    lstConsultasaldoster = SaldosTercerosSer.ListarSaldosTercerosNIIF(datosApp, ref SalIni, ref TotDeb, ref TotCre, ref SalFin, (Usuario)Session["usuario"]);
                    gvLista.EmptyDataText = emptyQuery;
                    ...
                    Session.Add(SaldosTercerosSer.CodigoProgramaNIIF + ".consulta", 1);
                }
            ...
            {
                BOexcepcion.Throw(SaldosTercerosSer.CodigoProgramaNIIF, "Actualizar", ex);
            }
        }        
    }
    ...
    protected void btnInforme_Click(object sender, EventArgs e)
    {
        ...
        if (Session["DTSALDOSTER"] != null)
        {
            ...
            ReportDataSource rds = new ReportDataSource("DataSet1", CrearDataTablesaldos());
