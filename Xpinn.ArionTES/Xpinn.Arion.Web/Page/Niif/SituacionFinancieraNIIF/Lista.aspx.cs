...
{
    private Xpinn.NIIF.Services.SituacionFinancieraService SituacionFinancieraSer = new Xpinn.NIIF.Services.SituacionFinancieraService();
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                VisualizarOpciones(SituacionFinancieraSer.CodigoProgramaNIIF, "L");
                pCodigo = SituacionFinancieraSer.CodigoProgramaNIIF;
            }
    ...
    protected void LlenarCombos()
    {
        ...
        List<Xpinn.NIIF.Entities.SituacionFinanciera> lstFechaCierre = new List<Xpinn.NIIF.Entities.SituacionFinanciera>();
        ...
        Xpinn.NIIF.Entities.SituacionFinanciera SituacionFinanciera = new Xpinn.NIIF.Entities.SituacionFinanciera();
        lstFechaCierre = SituacionFinancieraSer.ListarFecha((Usuario)Session["Usuario"]);
    ...
    private void Actualizar(String pIdObjeto)
    {
        ...
        try
        {
            ...
            Xpinn.NIIF.Entities.SituacionFinanciera datosApp = new Xpinn.NIIF.Entities.SituacionFinanciera();
            ...
            List<Xpinn.NIIF.Entities.SituacionFinanciera> lstConsultaSituacionFinanciera = new List<Xpinn.NIIF.Entities.SituacionFinanciera>();
            lstConsultaSituacionFinanciera.Clear();
            int pOpcion = Request.QueryString["niif"] != null ? 2 : 1;
            lstConsultaSituacionFinanciera = SituacionFinancieraSer.ListarSituacionFinanciera(datosApp, (Usuario)Session["usuario"], pOpcion);

            gvLista.EmptyDataText = emptyQuery;
            Session["DTSITUACIONFINANCIERA"] = lstConsultaSituacionFinanciera;

            if (lstConsultaSituacionFinanciera.Count > 0)
            {
                List<Xpinn.NIIF.Entities.SituacionFinanciera> lstConsulta = new List<Xpinn.NIIF.Entities.SituacionFinanciera>();
                gvLista.Visible = true;
                int indice = 0;
                Int64? nivel = null;
                foreach (Xpinn.NIIF.Entities.SituacionFinanciera item in lstConsultaSituacionFinanciera)
                {
                    Xpinn.NIIF.Entities.SituacionFinanciera rNuevo1 = new Xpinn.NIIF.Entities.SituacionFinanciera();
                    ...
                    if (nivel != null)
                    {
                        if (nivel != item.nivel)
                        {
                            if (item.nivel <= 2)
                            {
                                Xpinn.NIIF.Entities.SituacionFinanciera rNuevo = new Xpinn.NIIF.Entities.SituacionFinanciera();
                ...
                Session["DTSITUACIONFINANCIERA"] = lstConsulta;
    ...
    public DataTable CrearDataTableSituacionFinanciera()
    {

        List<Xpinn.NIIF.Entities.SituacionFinanciera> lstSituacionFinanciera = new List<Xpinn.NIIF.Entities.SituacionFinanciera>();
        lstSituacionFinanciera = (List<Xpinn.NIIF.Entities.SituacionFinanciera>)Session["DTSITUACIONFINANCIERA"];
        ...
        foreach (Xpinn.NIIF.Entities.SituacionFinanciera item in lstSituacionFinanciera)
        {
    ...
    protected void btnInforme_Click(object sender, EventArgs e)
    {
        ...
        VerError("");
        if (Session["DTSITUACIONFINANCIERA"] == null)
        {
        ...
        if (Session["DTSITUACIONFINANCIERA"] != null)
        {
            ...
            List<Xpinn.NIIF.Entities.SituacionFinanciera> lstBalanceGenComp = new List<Xpinn.NIIF.Entities.SituacionFinanciera>();
            lstBalanceGenComp = (List<Xpinn.NIIF.Entities.SituacionFinanciera>)Session["DTSITUACIONFINANCIERA"];
            ...
            ReportDataSource rds = new ReportDataSource("DataSetSituacionFinanciera", CrearDataTableSituacionFinanciera());
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        try
        {
            if (gvLista.Rows.Count > 0 && Session["DTSITUACIONFINANCIERA"] != null)
            {
                ...
                gvLista.DataSource = Session["DTSITUACIONFINANCIERA"];
                gvLista.DataBind();
