                ...
                <tr>
                    <td>
                        <div style="max-width: 1200px;max-height:700px; overflow: scroll">
                            <asp:GridView ID="gvLista" Width="100%" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvLista_RowDataBound"
                ...
                <tr>
                    <td>                        
                        <rsweb:ReportViewer ID="rvLibAux" runat="server" Font-Names="Verdana" 
                            ...
                            <LocalReport ReportPath="Page\Niif\LibroAuxiliarNIF\rptLibroAuxiliarNiif.rdlc">
                                <DataSources>
