        ...
        <table cellpadding="5" cellspacing="0" style="width: 70%">
            ...
            <tr>
                <td style="height: 15px; text-align: left;">
                    Id.Area<br />
                    <asp:TextBox ID="txtArea" runat="server" CssClass="textbox" Width="119px"></asp:TextBox>
                </td>
                <td style="height: 15px; text-align: left;">
                    Id.Centro Costo<br />
            ...
            <td>
                <asp:GridView ID="gvLista" runat="server" Width="80%" 
                    ...
                    <Columns>                   
                        ...
                        <asp:BoundField DataField="DescripcionArea" HeaderText="Descripcion Area" >
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="IdCentroCosto" HeaderText="Centro Costo" >
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
