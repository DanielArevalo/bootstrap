        ...
        <table cellpadding="5" cellspacing="0" style="width: 70%">
            ...
            <tr>
                <td style="height: 15px; text-align: left;">
                    Id Requisicion<br />
                    <asp:TextBox ID="txtTipoArticulo" runat="server" CssClass="textbox" Width="119px"></asp:TextBox>
                </td>
        ...
        <tr>  
            <td>
                <asp:GridView ID="gvLista" runat="server" Width="80%" 
                    ...
                    OnRowDataBound="gvLista_RowDataBound" DataKeyNames="IdRequisicion" 
                    ...
                    <Columns>                   
                        ...
                        <asp:BoundField DataField="IdRequisicion" HeaderText="IdRequisicion" >
                            <ItemStyle HorizontalAlign="Left" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="fecha_requsicion" HeaderText="fecha_requsicion" >
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="fecha_est_entrega" HeaderText="fecha_est_entrega" >
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                          <asp:BoundField DataField="fecha_crea" HeaderText="fecha_crea" >
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>                      
