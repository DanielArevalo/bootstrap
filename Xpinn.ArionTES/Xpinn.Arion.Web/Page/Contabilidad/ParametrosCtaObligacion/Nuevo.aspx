        ...
        <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="650px">
            ...
            <tr>
                <td colspan="2" style="text-align: left;">
                    Línea de Obligación<br />
                    <asp:DropDownList ID="ddlLineObligacion" runat="server" Height="25px" 
            ...
            <tr>
                <td style="text-align: left">
                    Componente<br />
                    <asp:DropDownList ID="ddlComponente" runat="server" Height="25px" Width="90%" CssClass="textbox"
                        AppendDataBoundItems="True">
                    </asp:DropDownList>
                </td>
                <td style="text-align: left">
                    Estructura<br />
                    <asp:DropDownList ID="ddlEstructura" runat="server" Height="25px" Width="85%" CssClass="textbox"
                        AppendDataBoundItems="True">
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    Entidad<br />
                    <asp:DropDownList ID="ddlEntidad" runat="server" Height="26px" Width="80%" CssClass="textbox"
                        AppendDataBoundItems="True">                        
                    </asp:DropDownList>
                </td>
            </tr>
