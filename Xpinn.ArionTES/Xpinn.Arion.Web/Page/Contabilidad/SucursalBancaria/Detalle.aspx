<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Detalle.aspx.cs" Inherits="Nuevo" Title=".: Xpinn - Concepto :." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="tdD">
                <asp:TextBox ID="txtConsecutivo" runat="server" CssClass="textbox" 
        ...
        <tr>
            <td class="tdI" style="text-align:left">
                Código Interno<br/>
                <asp:TextBox ID="txtCodInt" runat="server" CssClass="textbox" Enabled="False" />
