<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - Cta Contable :." %>
            ...
            <td colspan="2">
                <asp:GridView ID="gvLista" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="nom_cue_local" HeaderText="Nom Cuenta">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                      ...
                      <%--  <asp:BoundField DataField="nom_est_det" HeaderText="Estructura">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>--%>
                        <asp:BoundField DataField="cod_cuenta_niif" HeaderText="Cod.NIFF">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="nom_cue_niff" HeaderText="Nombre NIFF">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="cod_cuenta_contra" HeaderText="Cod.Nomina">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="nom_cue_contra" HeaderText="Nombre Nomina">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                      <asp:BoundField DataField="nom_concepto" HeaderText="Concepto">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                    </Columns>
