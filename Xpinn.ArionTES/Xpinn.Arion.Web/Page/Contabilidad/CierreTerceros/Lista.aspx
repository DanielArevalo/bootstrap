<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - Cierre Terceros :." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:MultiView ID="mvCierreTerceros" runat="server" ActiveViewIndex="0">
