<%@ Page Title="" Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Patronales.aspx.cs" Inherits="Lista" %>
            ...
            <asp:GridView ID="gvLista" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>                           
                    ...
                    <asp:TemplateField HeaderText="Cod.Cuenta Gasto">
                        <ItemTemplate>
                            <cc1:DropDownListGrid ID="ddlCodCuentaGasto" runat="server" Width="150px"
                                CommandArgument="<%#Container.DataItemIndex %>" AppendDataBoundItems="True" >
                                <asp:ListItem Value="" Text="" />
                            </cc1:DropDownListGrid>  
                        </ItemTemplate>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center; font-size: large;" colspan="3">
                    ...
                    <br />
                    <br />
                    Se ha realizado correctamente el comprobante
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align: center; font-size: large;width:40%">
                    <br />
                    <asp:Label ID="lblOperacion" runat="server" Text="" />
                </td>
                <td style="text-align: center; font-size: large; width:35%">     
                    &#160;             
                </td>
