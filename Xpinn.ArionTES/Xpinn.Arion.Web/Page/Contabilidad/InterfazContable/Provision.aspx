<%@ Page Title="" Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Provision.aspx.cs" Inherits="Lista" %>
        ...
        <div id="divLista" runat="server" style="overflow: scroll; height: 600px">
            <asp:GridView ID="gvLista" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>                           
                    ...
                    <asp:BoundField DataField="total" HeaderText="Vr.Provisión" DataFormatString="{0:n}" >
                    ...
                    <asp:TemplateField HeaderText="Cod.Cuenta Cre">
                        <ItemTemplate>
                            <cc1:DropDownListGrid ID="ddlCodCuentaCre" runat="server" Width="150px"
                                CommandArgument="<%#Container.DataItemIndex %>" AppendDataBoundItems="True" >
                                <asp:ListItem Value="" Text="" />
                            </cc1:DropDownListGrid>  
                        </ItemTemplate>
