...
partial class Lista : GlobalWeb
{
    ...
    protected void CargarListas()
    {
        ...
        lstConsulta = InterfazNominaServicio.ListarPeriodos((Usuario)Session["usuario"]);
    ...
    private void Actualizar()
    {
        ...
        try
        {
            string filtro = " And b.iden_concepto Not In ('7', '51', '52', '55') ";
    ...
    {
        string pFiltro = " And b.iden_concepto  Not In ('7', '51', '52', '55') ";
        VerError("");        
        ...
        if (!InterfazNominaServicio.GenerarComprobantePorEmpleado(Convert.ToInt64(ddlPeriodo.SelectedItem.Value), fechaAplicacion, lstConsulta, Convert.ToInt64(pCodProceso), pFiltro, "E", (Usuario)Session["Usuario"], ref error, ref lstOperacion))
        {
