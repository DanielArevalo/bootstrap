...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <hr />
        <asp:GridView ID="gvLista" runat="server" Width="80%" AutoGenerateColumns="False"
            ...
            OnRowDataBound="gvLista_RowDataBound" DataKeyNames="cod_tipo_impuesto">
            <Columns>                   
                ...
                <asp:BoundField DataField="cod_tipo_impuesto" HeaderText="Código" >
                    <ItemStyle HorizontalAlign="Left" Width="50px" />
                </asp:BoundField>
                <asp:BoundField DataField="nombre_impuesto" HeaderText="Nombre" >
