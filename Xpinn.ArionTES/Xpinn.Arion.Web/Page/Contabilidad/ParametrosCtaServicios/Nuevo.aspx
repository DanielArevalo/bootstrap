        ...
        <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="650px">
            ...
            <tr>
                <td colspan="2" style="text-align: left;">
                    Línea de Servicios<br />
                    <asp:DropDownList ID="ddlLineaServicio" runat="server" Height="25px" Width="90%" CssClass="textbox"
            ...
            <tr>
                <td style="text-align: left;">
                    Atributo<br />
                    <asp:DropDownList ID="ddlAtributos" runat="server" Height="26px" Width="100%" CssClass="textbox">
                        <asp:ListItem Text="Capital" Value="1" />
                         <asp:ListItem Text="Interes" Value="2" />
