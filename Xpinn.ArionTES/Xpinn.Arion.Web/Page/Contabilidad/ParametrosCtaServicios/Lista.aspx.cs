...
{
    ParametrosCtaServiciosService objetoLineaService = new ParametrosCtaServiciosService();

    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(objetoLineaService.CodigoPrograma, "L");
        ...
        {
            BOexcepcion.Throw(objetoLineaService.CodigoPrograma, "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                CargarListas();
                CargarValoresConsulta(pConsulta, objetoLineaService.CodigoPrograma);
                Actualizar();
            }
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(objetoLineaService.CodigoPrograma, "Page_Load", ex);
        }
    }
    ...
    private void CargarListas()
    {
        try
        {
            ...
            PoblarLista("lineasservicios", ddlLineaAporte);
    ...
    private string obtFiltro()
    {
        ...
        if (ddlLineaAporte.SelectedIndex != 0)
            filtro += " and ls.cod_linea_servicio = '" + ddlLineaAporte.SelectedValue+ "'";
        if (txtCodCuenta.Text != "")
            filtro += " and pc.cod_cuenta = '" + txtCodCuenta.Text + "'";
        if (ddltipotransaccion.SelectedIndex != 0)
            filtro += " and tt.tipo_tran = " + ddltipotransaccion.SelectedValue;
    ...
    private void Actualizar()
    {
        try
        {
            ...
            List<par_cue_linser> lstConsulta = new List<par_cue_linser>();
            lstConsulta = objetoLineaService.Listarpar_cue_linser(new par_cue_linser() {cod_linea_servicio = filtro }, (Usuario)Session["usuario"]);
            ...
            Session.Add(objetoLineaService.CodigoPrograma + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(objetoLineaService.CodigoPrograma, "Actualizar", ex);
        }
    }
    ...
    {
        Session[objetoLineaService.CodigoPrograma + ".id"] = null;
        Navegar(Pagina.Nuevo);
    }

    protected void btnConsultar_Click(object sender, ImageClickEventArgs e)
    {
        GuardarValoresConsulta(pConsulta, objetoLineaService.CodigoPrograma);
        Actualizar();
    }

    protected void btnLimpiar_Click(object sender, ImageClickEventArgs e)
    {
        LimpiarValoresConsulta(pConsulta, objetoLineaService.CodigoPrograma);
    }
    ...
    protected void gvLista_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Session[objetoLineaService.CodigoPrograma + ".id"] = id;
        Navegar(Pagina.Nuevo);
    }
    ...
    protected void btnContinuarMen_Click(object sender, EventArgs e)
    {
        try
        {
            objetoLineaService.Eliminarpar_cue_linser(Convert.ToInt64(Session["ID"].ToString()), (Usuario)Session["usuario"]);
            Actualizar();
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(objetoLineaService.CodigoPrograma, "btnContinuarMen_Click", ex);
        }
    }
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(objetoLineaService.CodigoPrograma, "gvLista_PageIndexChanging", ex);
        }
    }
}