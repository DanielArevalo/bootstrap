                    ...
                    <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0">
                        ...
                        <tr>
                            <td style="text-align:left;width:200px">
                                Línea<br />
                                <asp:DropDownList ID="ddlLineaAporte" runat="server" Height="25px" Width="95%"
            ...
            <td>
                <asp:GridView ID="gvLista" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NombreLinea" HeaderText="Linea de Servicio">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="cod_cuenta" HeaderText="Cod. Cuenta">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="NombreCuenta" HeaderText="Nombre de la Cuenta">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="tipo_tranN" HeaderText="Tipo Transaccion">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="tipo_mov" HeaderText="Tipo Movimiento">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="cod_est_det" HeaderText="Estructura">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                    </Columns>
