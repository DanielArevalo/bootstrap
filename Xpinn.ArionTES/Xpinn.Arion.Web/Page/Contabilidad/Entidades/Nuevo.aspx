    ...
    <table border="0" cellpadding="5" cellspacing="0" width="100%" >
        <tr style="text-align:left">
            <td class="tdI" style="text-align:left">
                Código&nbsp;*&nbsp;<asp:RequiredFieldValidator ID="rfvcod_banco" runat="server" ControlToValidate="txtCodBanco" ErrorMessage="Campo Requerido" SetFocusOnError="True" ValidationGroup="vgGuardar" ForeColor="Red" Display="Dynamic"/><br />
                <asp:TextBox ID="txtCodBanco" runat="server" CssClass="textbox" MaxLength="128" />
            </td>
            <td class="tdD">
            </td>
        </tr>
