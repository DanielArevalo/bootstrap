<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - Balance Comprobacion por Terceros:." %>
    ...
    <asp:MultiView ID="mvBalance" runat="server" ActiveViewIndex="0">
        <asp:View ID="vwDatos" runat="server">
            ...
            <table border="0" cellpadding="0" cellspacing="0" >
                ...
                <tr>
                    <td>                                
                        <asp:GridView ID="gvLista" runat="server" onrowdatabound="gvLista_RowDataBound"
                            ...
                            RowStyle-CssClass="gridItem" Width="100%" style="font-size: xx-small" >
                            <Columns>                        
                                ...
                                <asp:BoundField DataField="debitos" HeaderText="Debitos" DataFormatString="{0:c}" >
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="creditos" HeaderText="Creditos" DataFormatString="{0:c}" >
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="saldo_final" HeaderText="Saldo Final" DataFormatString="{0:c}" >
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                            </Columns>
