    ...
    <table border="0" cellpadding="5" cellspacing="0" width="60%" >
        ...
        <tr>
            <td colspan="2" width="100%" style="text-align: left">
                Oficina&nbsp;<asp:RequiredFieldValidator ID="rfvoficina" runat="server" 
                    ...
                    Display="Dynamic"/>
                <br />
                <asp:DropDownList ID="ddlOficina" runat="server" CssClass="textbox" Width="60%">
        ...
        <tr>
            <td width="50%" style="text-align: left">
                ...
                <br />
                <asp:TextBox ID="txtRangoInicial" runat="server" CssClass="textbox" 
        ...
        <tr>
            <td width="50%" style="text-align: left">
                ...
                <asp:CalendarExtender ID="ceFechaAsignacion" runat="server" 
                    ...
                    TargetControlID="txtFechacreacion" TodaysDateFormat="dd/MM/yyyy">
