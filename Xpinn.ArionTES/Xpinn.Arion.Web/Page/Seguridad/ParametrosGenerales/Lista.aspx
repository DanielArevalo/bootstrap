        ...
        <asp:View ID="vwDatos" runat="server">
            ...
            <div style="overflow:scroll;height:500px;width:100%;">
                <asp:GridView ID="gvLista" runat="server" Width="88%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:BoundField DataField="cod_opcion" HeaderText="Código">
                        ...
                        <asp:TemplateField HeaderText="Valor">
                            <ItemTemplate>
                                <cc1:TextBoxGrid ID="txtvalor" runat="server" Text='<%# Eval("valor") %>' style="text-align: right"
                                    Enabled="True" OnTextChanged="txtvalor_TextChanged" CommandArgument='<%#Container.DataItemIndex %>' AutoPostBack="True" Width="120px" />
                            </ItemTemplate>
