<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - CDATS Administración:." %>
                ...
                <td style="text-align: left; width: 100%">
                    ...
                    <div style="overflow: scroll; width: 90%">
                        <asp:GridView ID="gvLista" runat="server" GridLines="Horizontal" AutoGenerateColumns="False"
                            ...
                            RowStyle-CssClass="gridItem" DataKeyNames="codigo_cdat,estado" OnRowCommand="gvLista_RowCommand">
                            <Columns>
