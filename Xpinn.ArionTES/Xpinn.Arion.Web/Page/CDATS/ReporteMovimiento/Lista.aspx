    ...
    <asp:Panel ID="pConsulta" runat="server">
        <table width="100%">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    Identificación<br />
                    <asp:TextBox ID="txtIdentificacion" runat="server" CssClass="textbox" Width="200px" />
                </td>
                <td style="text-align: left">
                    Nombre<br />
                ...
                <asp:Panel ID="panelGrilla" runat="server">
                    ...
                    <asp:GridView ID="gvLista" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="numero_cdat" HeaderText="Num Cuenta">
                                <ItemStyle HorizontalAlign="center" />
                            </asp:BoundField>
                             <asp:BoundField DataField="numero_fisico" HeaderText="Número Físico">
                                <ItemStyle HorizontalAlign="center" />
                            </asp:BoundField>
