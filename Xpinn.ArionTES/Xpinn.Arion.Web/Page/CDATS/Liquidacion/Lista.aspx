...
<asp:MultiView ID="mvPrincipal" runat="server" ActiveViewIndex=0>
 ...
 <td style="text-align: left">
                    &nbsp;&nbsp;
                    <asp:CheckBox ID="chkSoloInteres" runat="server" Text="Solo con Interés" />
                    &nbsp;&nbsp;
                    <asp:CheckBox ID="cbCapitalizaInteres" runat="server" AutoPostBack="true" Text="Capitaliza Interés" OnCheckedChanged="cbCapitalizaInteres_CheckedChanged" />
                </td>                
