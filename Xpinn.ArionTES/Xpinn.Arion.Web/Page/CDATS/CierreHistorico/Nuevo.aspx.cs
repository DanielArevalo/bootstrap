...
partial class Nuevo : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(AperturaService.codigoprogramaCierreHistorico, "L");
        ...
        {
            BOexcepcion.Throw(AperturaService.GetType().Name + "L", "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Label2.Visible = true;
                Label2.Text = Convert.ToString(Session["MensajeCdats"]);

            
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(AperturaService.GetType().Name + "L", "Page_Load", ex);
        }
    }
    ...
    protected void LlenarCombos()
    {
        ...
        lstFechaCierre = AperturaService.ListarFechaCierre((Usuario)Session["Usuario"]);
    ...
    public void TerminarProceso()
    {
        ...
        Label2.Text = Session["MensajeCdats"].ToString();
    }
    ...
    public void EjecutaProceso()
    {
        ...
        try
        {
            Xpinn.CDATS.Services.AperturaCDATService CdatServicio = new Xpinn.CDATS.Services.AperturaCDATService();
            Xpinn.CDATS.Entities.Cdat cdat = new Xpinn.CDATS.Entities.Cdat();

            AperturaService.ciCierreHistorico(cdat, estado, fecha, codusuario, ref sError, (Usuario)Session["usuario"]);
            Session["MensajeCdats"] = "Cierre Mensual Terminado Correctamente";
        ...
        catch (Exception ex)
        {
            ...
            if (n > 0)
            {
                ...
                Session["MensajeCdats"] = lblError.Text;
                Label2.Visible = true;
                Label2.Text = Convert.ToString(Session["MensajeCdats"]);
                Session["Proceso"] = "FINAL";
            }
