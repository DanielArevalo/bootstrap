...
public partial class Page_Reporteador_Reportes_ReportesExogena_ReporteCausacion : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(objReporteService.CodigoReporteCausacion, "L");
    ...
    private void btnExportar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            DataTable dtResultado = objReporteService.ReporteCausacion(Convert.ToInt32(txtAño.Text), (Usuario)Session["Usuario"]);
