            ...
            <tr>
                <td style="text-align: left; width:100%"> 
                    <asp:GridView ID="gvProductos" runat="server" AutoGenerateColumns="False" GridLines="Horizontal" HeaderStyle-CssClass="gridHeader"
                        PagerStyle-CssClass="gridPager" PageSize="20" RowStyle-CssClass="gridItem" Style="font-size: xx-small" Width="100%"  OnRowDataBound="gvProductos_OnRowDataBound">
                        <Columns>                      
                            ...
                            <asp:BoundField DataField="Asesor" HeaderText="Asesor" ><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <%--<asp:TemplateField HeaderStyle-CssClass="gridIco" HeaderText="Saldos" ItemStyle-Width="140px">
                                <ItemTemplate>
                                    <asp:GridView ID="gvSaldos" runat="server" AutoGenerateColumns="False" Style="font-size: xx-small" Width="100%">
                                        <Columns>                      
                                            <asp:BoundField DataField="tipoproducto" HeaderText="Producto"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                                            <asp:BoundField DataField="monto" HeaderText="Saldo" DataFormatString="{0:c0}"><ItemStyle HorizontalAlign="Right"/></asp:BoundField>
                                            <asp:BoundField DataField="cantidad" HeaderText="#" DataFormatString="{0:n0}"><ItemStyle HorizontalAlign="Center" /></asp:BoundField>
                                        </Columns>
                                    </asp:GridView>
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridIco"></HeaderStyle>
                            </asp:TemplateField>--%>
                            <asp:BoundField HeaderText="Saldo Aportes" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                             <asp:BoundField HeaderText="Cuota Aporte" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <asp:BoundField HeaderText="Saldo Créditos" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                             <asp:BoundField HeaderText="Cuota Créditos" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <asp:BoundField HeaderText="Saldo A. Vista" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                              <asp:BoundField HeaderText="Cuota A. Vista" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <asp:BoundField HeaderText="Saldo CDATS" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                             <asp:BoundField HeaderText="Cuota CDATS" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <asp:BoundField HeaderText="Saldo A. Programado" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                                <asp:BoundField HeaderText="Cuota A. Programado" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <asp:BoundField HeaderText="Saldo Servicios" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                            <asp:BoundField HeaderText="Cuota Servicios" ItemStyle-Width="100px"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                        </Columns>
