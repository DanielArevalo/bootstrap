...
public partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(objReporteService.CodigoProgramaReporteTransaccionesGarantias, "L");
    ...
    private void btnExportar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            DataTable dtResultado = objReporteService.ConsultarTransacciones_GarantiasComunitarias(DateTime.Parse(ucFechaCorte.Text),  (Usuario)Session["Usuario"]);
