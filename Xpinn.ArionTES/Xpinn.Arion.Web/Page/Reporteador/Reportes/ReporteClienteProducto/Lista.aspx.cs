...
public partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(objReporteService.CodigoProgramaReporteClientesProductos, "L");
    ...
    private void btnExportar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            DataTable dtResultado = objReporteService.ConsultarPersonasProductos(DateTime.Parse(ucFechaCorte.Text),  (Usuario)Session["Usuario"]);
