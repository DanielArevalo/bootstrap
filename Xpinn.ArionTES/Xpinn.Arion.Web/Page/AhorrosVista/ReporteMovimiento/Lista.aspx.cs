...
partial class Lista : GlobalWeb
{
    ...
    void cargarDropdown()
    {
        ...
        pData.estado = 1;
        lstLineas = ReporteMovService.ListarDropDownLineasAhorro(pData, (Usuario)Session["usuario"]);
    ...
    private void Actualizar()
    {
        try
        {
            List<AhorroVista> lstConsulta = new List<AhorroVista>();
            ...
            lstConsulta = ReporteMovService.ListarAhorroVista(filtro, pFechaApert,(Usuario)Session["usuario"]);
    ...
    private string obtFiltro()
    {
        ...
        if (txtNumCta.Text.Trim() != "")
            filtro += "AND A.NUMERO_CUENTA = '"+txtNumCta.Text.Trim()+"'";
