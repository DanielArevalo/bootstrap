            ...
            <asp:Panel ID="pConsulta" runat="server">            
                <table cellpadding="5" cellspacing="0" style="width: 70%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; " >
                            Saldo Canje<br />
                            <asp:TextBox   ID="TxtSaldo" runat="server" CssClass="textbox" Enabled="false" Width="100px" enable="false" DataFormatString="{0:n0}" ></asp:TextBox>                    
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="N.Cuenta">
                                       ...
                                       <asp:TemplateField HeaderText="Línea">
                                        ...
                                        <asp:TemplateField HeaderText="GMF" Visible="False" >
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="Cod.Persona">
                                            <ItemTemplate>
                                                <asp:label ID="lblcodpersona"  AutoPostBack="True" runat="server" Text='<%# Eval("cod_persona") %>'
