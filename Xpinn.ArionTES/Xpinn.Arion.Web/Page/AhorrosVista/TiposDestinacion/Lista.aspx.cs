...
partial class Lista : GlobalWeb
{
    ...
    private void Actualizar()
    {
        try
        {
            List<Xpinn.Ahorros.Entities.Destinacion> lstConsulta = new List<Xpinn.Ahorros.Entities.Destinacion>();
    ...
    private Xpinn.Ahorros.Entities.Destinacion ObtenerValores()
    {
        Xpinn.Ahorros.Entities.Destinacion vDestinacion = new Xpinn.Ahorros.Entities.Destinacion();
