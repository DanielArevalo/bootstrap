            ...
            <td>
                ...
                <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="50%">
                   <tr>
                       ...
                       <td style="text-align: left">
                           Descripcion<br/>
                           <asp:TextBox ID="txtDescripcion" runat="server" CssClass="textbox" MaxLength="128" Width="200" />
                       </td>
                   </tr>
                </table>
                </asp:Panel>
        ...
        <tr>
            <td>
                ...
                HeaderStyle-CssClass="gridHeader" PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem"  DataKeyNames="cod_destino" >
                    <Columns>
                        <asp:BoundField DataField="cod_destino" HeaderStyle-CssClass="gridColNo" 
                        ...
                        <asp:BoundField DataField="cod_destino" HeaderText="Código" >
