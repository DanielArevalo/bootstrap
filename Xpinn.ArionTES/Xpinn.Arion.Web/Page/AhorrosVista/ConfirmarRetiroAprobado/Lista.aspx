                            ...
                            <asp:GridView ID="gvLista" runat="server" Width="100%" GridLines="Horizontal" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                            <asp:TemplateField HeaderText="Rechazar" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:ImageButton runat="server" Visible='<%# Eval("estado_modificacion").ToString().Trim() != "Pre-aprobado" ? false:true %>' ID="imgRechazar" CommandName="Edit" ImageUrl="~/Images/gr_elim.jpg" />                                                    
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Aprobar">
                                                <ItemTemplate>
                                                    <asp:ImageButton runat="server" Visible='<%# Eval("estado_modificacion").ToString().Trim() != "Pre-aprobado" ? false:true %>' ID="imgAprobar" CommandName="Select" ImageUrl="~/Images/gr_credit.jpg" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <asp:BoundField HeaderText="Estado Cuenta" DataField="nom_estado">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField HeaderText="Aprobado por" DataField="aprobador">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                     <asp:BoundField HeaderText="Fec. Aprobacion" DataField="fecha_aprobacion" DataFormatString="{0:d}">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
