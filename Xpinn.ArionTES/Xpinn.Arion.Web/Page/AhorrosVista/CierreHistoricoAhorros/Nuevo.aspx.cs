...
public partial class Nuevo : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(ahorrosServicio.CodigoProgramaHis, "L");
        ...
        {
            BOexcepcion.Throw(ahorrosServicio.GetType().Name + "L", "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            Label2.Visible = true;
            Label2.Text = Convert.ToString(Session["MensajeAhorros"]);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(ahorrosServicio.GetType().Name + "L", "Page_Load", ex);
        }
    }
    ...
    protected void LlenarCombos()
    {
        ...
        lstFechaCierre = ahorrosServicio.ListarFechaCierre((Usuario)Session["Usuario"]);
    ...
    public void TerminarProceso()
    {
        ...
        Label2.Text = Session["MensajeAhorros"].ToString();
    ...
    public void EjecutaProceso()
    {
      //  Session["Mensaje"] = null;
        ...
        try
        {
            Xpinn.Ahorros.Services.AhorroVistaServices AportesServicio = new Xpinn.Ahorros.Services.AhorroVistaServices();
            Xpinn.Ahorros.Entities.AhorroVista ahorros = new Xpinn.Ahorros.Entities.AhorroVista();
            ahorrosServicio.ciCierreHistorico(ahorros, estado, fecha, codusuario, ref sError, (Usuario)Session["usuario"]);
            Session["MensajeAhorros"] = "Cierre Mensual Terminado Correctamente";
        ...
        catch (Exception ex)
        {
            ...
            if (n > 0 )
            {
                ...
                Session["MensajeAhorros"] = lblError.Text;
                Label2.Visible = true;
                Label2.Text = Convert.ToString(Session["MensajeAhorros"]);
                Session["Proceso"] = "FINAL";
            }
    ...
    //    }
    //    estado = Convert.ToString(rbEstado.SelectedValue);
    //    lblCuentasNegativas.Text = ahorrosServicio.ValidarCierre(estado, fecha, codusuario, (Usuario)Session["usuario"]);
    //}
