    ...
    <table border="0" cellpadding="0" cellspacing="0" width="70%">
            ...
            <td>
                ...
                <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="50%">
                   <tr>
                       ...
                       <td style="text-align:left">
                           Descripcion<br/>
                           <asp:TextBox ID="txtDescripcion" runat="server" CssClass="textbox" MaxLength="300" Width="300" />
                       </td>
                   </tr>
                </table>
                </asp:Panel>
        ...
        <tr>
            <td>
                ...
                HeaderStyle-CssClass="gridHeader" PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem"  DataKeyNames="idmotivo_novedad" >
                    <Columns>
                        <asp:BoundField DataField="idmotivo_novedad" HeaderStyle-CssClass="gridColNo" 
                        ...
                        <asp:BoundField DataField="idmotivo_novedad" HeaderText="Código" >
