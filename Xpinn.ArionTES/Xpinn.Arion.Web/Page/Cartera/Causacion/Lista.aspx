<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" EnableEventValidation="true"
        ...
        <table style="width: 100%;">
            ...
            <tr style="text-align: center">
                <td align="center">
                    <br />
                    Estado del Proceso:
                    <asp:RadioButtonList ID="rbEstado" runat="server" RepeatDirection="Horizontal" Width="185px">
        ...
        <table style="width: 100%;">
            <tr>
                <td style="width: 70%; text-align: center">
                    <br />
                    <asp:Label ID="Label2" runat="server" Text="Proceso de Causación Terminado Correctamente" ></asp:Label>
                    <br />
                    <asp:Button ID="btnSalir" runat="server" Text="Salir"
                      CssClass="btn8"  Width="80px" onclick="btnSalir_Click" />
                </td>
            </tr>
        </table>
    </asp:Panel>
