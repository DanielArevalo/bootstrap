<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="Lista.aspx.cs" Inherits="Lista" EnableSessionState="true" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" style="width: 70%">
                    ...
                    <br />
                    <asp:Button ID="btnSalir" runat="server" Text="Salir" CssClass="btn8"  Width="100px" onclick="btnSalir_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table style="width: 100%;">
                <tr>
                    <td align="center" style="width: 100%"><br/>
                        <asp:Label ID="lblErrores" runat="server" Text="Lista de errores en el cierre"></asp:Label>
                        <uc1:gvLista ID="error" runat="server" Visible="true"/>
                        <br />
                        <asp:Button ID="Button1" runat="server" Text="Salir" CssClass="btn8"  Width="100px" onclick="btnSalir_Click" />
                        <asp:Button ID="Button2" runat="server" Text="Exportar" CssClass="btn8"  Width="100px" onclick="btnExportarErr_Click" />
                    </td>
                </tr>
            </table>
    </asp:Panel>
