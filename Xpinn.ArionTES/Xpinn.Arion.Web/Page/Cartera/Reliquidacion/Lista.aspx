                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 138px; text-align: left">
                                                <asp:DropDownList ID="ddlLineasCredito" AppendDataBoundItems="true" runat="server" CssClass="textbox"
                                                    Height="30px" Width="191px">
                                                    <asp:ListItem Text="Seleccione un Item" Value=" " />
                                                </asp:DropDownList>
                                                <br />
                                            </td>
                                            <td style="text-align: left">&nbsp;<asp:DropDownList ID="ddlOficinas" AppendDataBoundItems="true" runat="server" CssClass="textbox"
                                                Height="30px" Width="191px">
                                            </asp:DropDownList>
                                                <br />
                                            </td>
