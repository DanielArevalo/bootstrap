...
{
    private Xpinn.Cartera.Services.PazySalvoService PazySalvoService = new Xpinn.Cartera.Services.PazySalvoService();

    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(PazySalvoService.CodigoPrograma, "L");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                CargarValoresConsulta(pConsulta, PazySalvoService.CodigoPrograma);
                //if (Session[PazySalvoService.CodigoPrograma + ".consulta"] != null)
                //    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    protected void btnConsultar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            GuardarValoresConsulta(pConsulta, PazySalvoService.CodigoPrograma);
            Actualizar();
        }
    }
    ...
    protected void btnLimpiar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LimpiarValoresConsulta(pConsulta, PazySalvoService.CodigoPrograma);
    }
    ...
    protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[PazySalvoService.CodigoPrograma + ".id"] = id;
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(PazySalvoService.CodigoPrograma, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    private void Actualizar()
    {
        try
        {
            ...
            lstConsulta = PazySalvoService.ListarCredito(pFecha,filtro,(Usuario)Session["usuario"]);
            ...
            Session.Add(PazySalvoService.CodigoPrograma + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(PazySalvoService.CodigoPrograma, "Actualizar", ex);
        }
    }
