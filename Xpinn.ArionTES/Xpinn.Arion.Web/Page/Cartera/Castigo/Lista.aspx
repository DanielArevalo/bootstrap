                       ...
                       <td class="tdI">
                           <asp:Panel ID="Panel1" runat="server">
                               <table style="width:100%;">
                                   ...
                                   <tr>
                                       <td class="logo" style="width: 195px; text-align:left">
                                           <asp:TextBox ID="txtNumero_radicacion" runat="server" CssClass="textbox" Width="170px"
                                               MaxLength="128" />
                                       </td>
                                       <td style="width: 138px; text-align:left">
                        ...
                        <td class="tdI">
                            <asp:Panel ID="Panel2" runat="server">
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td class="logo" style="width: 197px; text-align:left">
                                            <asp:TextBox ID="txtIdentificacion" runat="server" CssClass="textbox" Width="170px" />
                                            <br />
                                        </td>
                                        ...
                                        <td style="text-align:left">
                                            <asp:TextBox ID="txtCodigoNomina" runat="server" CssClass="textbox" Width="191px" />
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
