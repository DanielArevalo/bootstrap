<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - Categorias :." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:GridView ID="gvLista" runat="server" Width="70%" AutoGenerateColumns="False"
        ...
        PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem" DataKeyNames="cod_categoria">
        <Columns>
            <asp:BoundField DataField="cod_categoria" HeaderStyle-CssClass="gridColNo" ItemStyle-CssClass="gridColNo">
            ...
            <asp:BoundField DataField="cod_categoria" HeaderText="Tipo Comprobante">
