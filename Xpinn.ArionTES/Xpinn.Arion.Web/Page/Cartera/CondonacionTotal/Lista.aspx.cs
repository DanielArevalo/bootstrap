...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(CondonacionTotalServicio.CodigoPrograma, "L");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                CargarValoresConsulta(pConsulta, CondonacionTotalServicio.CodigoPrograma);
                if (Session[CondonacionTotalServicio.CodigoPrograma + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    protected void btnConsultar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            GuardarValoresConsulta(pConsulta, CondonacionTotalServicio.CodigoPrograma);
            Actualizar();
        }    
    }
    ...
    {
        LimpiarValoresConsulta(pConsulta, CondonacionTotalServicio.CodigoPrograma);
    }
    ...
    protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[CondonacionTotalServicio.CodigoPrograma + ".id"] = id;
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(CondonacionTotalServicio.CodigoPrograma, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    private void Actualizar()
    {
        try
        {
            ...
            lstConsulta = CondonacionTotalServicio.ListarCredito(ObtenerValores(), (Usuario)Session["usuario"]);
            ...
            Session.Add(CondonacionTotalServicio.CodigoPrograma + ".consulta", 1);
        }
        catch (Exception ex)
        {
    ...
    /// </summary>
    /// <returns></returns>
    private Xpinn.Cartera.Entities.CondonacionTotal ObtenerValores()
    {
        Xpinn.Cartera.Entities.CondonacionTotal vCredito = new Xpinn.Cartera.Entities.CondonacionTotal();
    ...
    /// <returns></returns>
    private string obtFiltro(CondonacionTotal credito)
    {
