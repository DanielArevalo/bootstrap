           ...
           <ContentTemplate>
            <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="factor_riesgo" HeaderText="Factor Riesgo">
                    ...
                    <asp:TemplateField HeaderText="Calificación" >
                        <ItemTemplate>
                            <asp:Label ID="lblCalificacionSegmento" runat="server" Text='<%# Bind("calificacion_segmento") %>'></asp:Label>
                        </ItemTemplate>
