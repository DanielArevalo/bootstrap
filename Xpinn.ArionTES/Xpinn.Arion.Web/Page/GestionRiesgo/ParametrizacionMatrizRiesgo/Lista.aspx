            ...
            <table id="tbEncabezado" border="0" cellpadding="5" cellspacing="0" width="700px" style="text-align: left">
                <tr>
                    <td style="width: 120px; text-align: left"><br />
                        <asp:TextBox ID="txtCodigo" runat="server" CssClass="textbox" Width="90%" ReadOnly="true" Visible="false"/>
                    </td>
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    DataKeyNames="cod_matriz" HeaderStyle-CssClass="gridHeader" OnRowDataBound="gvLista_RowDataBound"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Left" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcodigoRango" runat="server" Text='<%# Bind("cod_matriz") %>'></asp:Label>
                                            </ItemTemplate>
