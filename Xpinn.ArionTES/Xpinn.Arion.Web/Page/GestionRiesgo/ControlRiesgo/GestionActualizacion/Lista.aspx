...
<%--                <td class="tdD" style="text-align: left; width: 110px">codigo Actulizacion<br />
                ...
                <td class="tdD" style="text-align: left; width: 150px">Identificacion<br />
                 ...
                 <td class="tdD" style="text-align: left; width: 150px">Primer Pellido<br />
    ...
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
         <%--   <asp:CommandField ButtonType="Image" EditImageUrl="~/Images/gr_edit.jpg" ShowEditButton="True" />
            ...
            <asp:BoundField DataField="Id_update" HeaderText="codigo Actulizacion">
            ...
            <asp:BoundField DataField="Primer_nombre" HeaderText="Primer nombre">
             ...
             <asp:BoundField DataField="Primer_Apellido" HeaderText="Primer Apellido">
                <ItemStyle HorizontalAlign="Left" Width="300px" />
                 ...
                 <asp:BoundField DataField="Fecha_act" HeaderText="Fecha actualizacion">
                <ItemStyle HorizontalAlign="Left" Width="300px" />
            </asp:BoundField>
        </Columns>
