...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:Panel ID="pConsulta" runat="server">
        ...
        <table id="tbCriterios" border:"0" cellpadding:"0" cellspacing:"0" width:"70%">
            ...
            <tr>
                <td class="" style="text-align: left; width: 120px">Codigo perfil<br />
                    <asp:TextBox ID="txtCodigoPer" runat="server" CssClass="textbox" Width="110px" />
                </td>
                ...
                <td class="tdD" style="text-align: left; width: 120px">Valoración<br />
                    <asp:DropDownList ID="ddlTipoPersona" runat="server" CssClass="textbox" Width="150px">
    ...
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Nombre" Visible="false">
                <ItemTemplate>
                    <asp:Label ID="lbltipopersona" runat="server" Text='<%# Eval("nomtipoPersona") %>' />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
