...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:Panel ID="pConsulta" runat="server">
        ...
        <table id="tbCriterios" border:"0" cellpadding:"0" cellspacing:"0" width:"70%">
            ...
            <tr>
                <td class="tdD" style="text-align: left; width: 250px">Nombre<br />
                    <asp:TextBox ID="txtNomdep" runat="server" CssClass="textbox"
                        MaxLength="100" Width="250px" />
                </td>
                <td class="tdD" style="text-align: left; width: 120px">Valoracion<br />
    ...
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False"
        ...
        DataKeyNames="COD_DEPA" Style="font-size: x-small" Width="70%">
        <Columns>
            <asp:CommandField ButtonType="Image" EditImageUrl="~/Images/gr_edit.jpg" ShowEditButton="True" />
            <asp:CommandField ButtonType="Image" DeleteImageUrl="~/Images/gr_elim.jpg" ShowDeleteButton="True" />
            <asp:BoundField DataField="COD_DEPA" HeaderText="CODIGO DEPARTAMENTO">
