<%@ Page Title="" Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true"
    CodeFile="Lista.aspx.cs" Inherits="Lista" EnableEventValidation="True" %>
        ...
        <asp:View ID="vwDatos" runat="server">
            <asp:Panel ID="PanelDatos" runat="server">
                ...
                <table style="width: 90%" cellspacing="4" cellpadding="4">
                    ...
                    <tr>
                        <td style="text-align: left; width: 150px; height: 50px;" colspan="2">
                            ...
                            <asp:Panel ID="panelperiodo" runat="server">                            
                                <asp:Label ID="lblTituloPeriodo1" runat="server" Text="Perìodo de" />
                                <br />
                                <ucFecha:fecha ID="txtFecIni" runat="server" CssClass="textbox" Width="85px" />
                                <asp:Label ID="lblTituloPeriodo2" runat="server" Text="a" />
            ...
            <asp:Panel ID="PanelFinal" runat="server">
                <table width="100%">
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:Label ID="lblResultado" runat="server" Text="Archivo de SUPERSOLIDARIA - SALDOS DIARIOS Generado Correctamente"></asp:Label>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
