...
{
    ConfecoopService AporteConService = new ConfecoopService();

    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(AporteConService.CodigoProgramaAporte, "L");                   
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(AporteConService.GetType().Name + "L", "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AporteConService.GetType().Name + "D", "Page_Load", ex);
        }
    }
    ...
    { 
        ...
        tipo = "A";
        estado = "D";
        ddlFecha.DataSource = AporteConService.ListarFechaCierreGLOBAL(tipo, estado, (Usuario)Session["usuario"]);
    ...
    protected void btnConsultar_Click(object sender, EventArgs e)
    {
        ...
        if (rbTipoArchivo.SelectedItem != null)
        {
            ...
            try
            {
                listaArchivo = AporteConService.ListarTEMP_SUPERSOLI_APORTES(pPuc, ref pError, (Usuario)Session["Usuario"]);
                if (pError != "")
                {
                    VerError(pError);
                    return;
