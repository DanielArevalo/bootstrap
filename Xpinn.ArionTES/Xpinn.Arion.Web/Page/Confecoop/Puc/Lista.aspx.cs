...
public partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(pucService.CodigoPrograma, "L");
    ...
    private void CargarDropDown()
    {
        ...
        ddlTipoCuenta.Items.Insert(2, new ListItem("Local Homologada", "2"));
    ...
    protected void btnConsultar_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                VerError("Debe ingresar la fecha, verifique los datos");
                return;
            }
        }
        ...
        if (rbTipoArchivo.SelectedItem != null)
        {
            ...
            pPuc.a_fecha_corte = 0;
            if (cbCorte.Checked)
                pPuc.a_fecha_corte = 1;
            ...
            if (cbCorte.Checked)
                ...
                pPuc.fecha = txtFecha.ToDateTime;

            string pError = "";
            try
            {
                listaArchivo = pucService.ListarTEMP_SUPERSOLIDARIA(pPuc, ref pError, (Usuario)Session["Usuario"], estado, pTipoNorma);
                if (pError != "")
                {
                    VerError(pError);
                    return;
