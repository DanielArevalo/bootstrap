        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <td style="text-align: left">Nombre<br />
                    <asp:TextBox ID="txtNombre" runat="server" Width="150px" CssClass="textbox" />
                </td>
                <td style="text-align: left" Width="300px">Fecha Solicitud<br />
                ...
                <td style="text-align: left">
                    ...
                    <asp:DropDownList ID="ddlEstado" runat="server" CssClass="textbox" Width="140px">
                        ...
                        <asp:ListItem Value="Z">Aplazados Pre-Inscripción</asp:ListItem>
                        <asp:ListItem Value="Y">Aplazados Inscripción</asp:ListItem>
            ...
            <tr>
                <td style="text-align: left">
                    <div style="overflow: scroll; max-width: 100%;">
                        <asp:GridView ID="gvLista" runat="server" Width="900px" GridLines="Horizontal" AutoGenerateColumns="False"
                            ...
                            RowStyle-CssClass="gridItem" DataKeyNames="numero_credito, fecha_solicitud, cod_convocatoria, cod_persona, estado, tipo_aprobacion">
                            <Columns>
                                ...
                                <asp:BoundField DataField="estado" HeaderText="Cod Estado" Visible="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="tipo_aprobacion" HeaderText="Tipo Aprobacion" Visible="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                            </Columns>
