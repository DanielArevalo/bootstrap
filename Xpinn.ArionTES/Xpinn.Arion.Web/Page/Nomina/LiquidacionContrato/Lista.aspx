...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <table border="0" style="height: 84px; width: 1100px" cellspan="1">
        <tr>
            <td style="width: 209px; height: 51px; text-align: center;" class="logo">
                <label>Codigo Liquidación</label>
                <br />
                <asp:TextBox ID="txtCodigoLiquidacion" CssClass="textbox" onkeypress="return isNumber(event)" runat="server" Width="160px">
                </asp:TextBox>
            </td>
            ...
            <td style="text-align: center; width: 150px; padding: 10px">
                ...
                <br />
                <asp:TextBox ID="txtFechaRetiro" MaxLength="10" CssClass="textbox"
                    runat="server" Width="80%"></asp:TextBox>
                <asp:CalendarExtender ID="CalendarExtender1" runat="server"
                    PopupButtonID="imagenCalendarioRetiro"
    ...
    <div style="overflow-x: scroll; max-width: 1205px;">
        <table border="0" style="width: 1200px">
            <tr>
                <td>
                    <asp:GridView ID="gvLiquidacion" runat="server" Width="100%" GridLines="Horizontal" AutoGenerateColumns="False"
                        OnPageIndexChanging="gvLiquidacion_PageIndexChanging" AllowPaging="True" OnSelectedIndexChanged="gvLiquidacion_SelectedIndexChanged"
                        OnRowCommand="OnRowCommandDeleting" OnRowDeleting="gvLiquidacion_RowDeleting"
...
<ItemStyle CssClass="gridIco"></ItemStyle>
                            ...
                            <asp:BoundField DataField="consecutivo" HeaderText="Cod. Liquidación">
                            ...
                            <asp:BoundField DataField="fecharetiro" DataFormatString="{0:d}" HeaderText="Fecha Retiro">
                                <ItemStyle HorizontalAlign="center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="valortotalpagar" HeaderText="Valor Pagar" DataFormatString="${0:#,##0.00}">
                                <ItemStyle HorizontalAlign="center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="fechacreacion" DataFormatString="{0:d}" HeaderText="Fecha Creación">
                                <ItemStyle HorizontalAlign="center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="desc_usuario" HeaderText="Usuario Creación">
