...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server"> 
        ...
        <asp:GridView ID="gvContent" runat="server" 
                    ...
                    <asp:BoundField DataField="maximo" HeaderText="Hasta/Prom. en UVT" ItemStyle-HorizontalAlign="Center" />
                          <asp:BoundField DataField="porcentaje" HeaderText="Tarifa" ItemStyle-HorizontalAlign="Center" />
                  </Columns>
