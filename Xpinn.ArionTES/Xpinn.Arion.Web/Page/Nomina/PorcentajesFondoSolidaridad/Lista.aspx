...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server"> 
        ...
        <asp:GridView ID="gvContent" runat="server" 
                     ...
                     <asp:BoundField DataField="minimo" HeaderText="Desde" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="maximo" HeaderText="Hasta" ItemStyle-HorizontalAlign="Center" />
                          <asp:BoundField DataField="porcentaje" HeaderText="Porcentaje" ItemStyle-HorizontalAlign="Center" />
                  </Columns>
