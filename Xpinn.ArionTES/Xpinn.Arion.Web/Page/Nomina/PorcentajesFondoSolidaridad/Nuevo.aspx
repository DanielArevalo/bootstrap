...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
                ...
                <table style=" width: 100%;">
                     <tr>
                        <td class="tdI" colspan="3" style="color: #FFFFFF; background-color: #0066FF; height: 20px;">
                            Rangos fondos de Solidaridadn</td>
                    </tr>
                </table>
  ...
  <table>
      ...
      <tr>
          <td style="height:40px; text-align: center;">
              <asp:Label ID="LblMinimo" runat="server" Text="Desde" Visible="true"></asp:Label>
              <br />
              <asp:TextBox ID="txtMinimo" runat="server" CssClass="textbox" Visible="true"></asp:TextBox>
          </td>
          <td style="height:40px; text-align: center ">
              <asp:Label ID="LblMaximo" runat="server" Text="Hasta" Visible="true"></asp:Label>
              <br />
