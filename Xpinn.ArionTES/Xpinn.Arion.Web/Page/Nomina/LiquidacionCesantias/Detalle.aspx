                            ...
                            <ContentTemplate>
                                <table id="tbCriterios" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 20%">
                                            <asp:CheckBox ID="cbCLiquidaInteres" runat="server" AutoPostBack="true" Text="Liquida Interés" />
                                            <br />
                                        </td>
                                        <td style="width: 20%">
                                            <asp:CheckBox ID="cbLiquidaCesantias" runat="server" AutoPostBack="true" Text="Liquida Cesantias" />
                                            <br />
                                        </td>
                                ...
                                <asp:GridView ID="gvLista"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="diasliquidar" HeaderText="Dias Liquidados" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField DataField="basecesantias" HeaderText="Base Cesantias" ItemStyle-HorizontalAlign="Center" DataFormatString="${0:#,##0.00}" />
                                        <asp:BoundField DataField="valortotalpagar" HeaderText="Cesantias" ItemStyle-HorizontalAlign="Center" DataFormatString="${0:#,##0.00}" />
                                        <asp:BoundField DataField="interes" HeaderText="Intereses" ItemStyle-HorizontalAlign="Center" DataFormatString="${0:#,##0.00}" />
                                        <asp:TemplateField HeaderStyle-CssClass="gridIco"><ItemTemplate><cc1:ButtonGrid runat="server" ID="btnVerRecibo" OnClick="btnVerRecibo_Click" Width="100px"
                                                    CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' Text="Ver Recibo" CssClass="btn8" /></ItemTemplate></asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="gridIco"><ItemTemplate><cc1:ButtonGrid runat="server" ID="btnVerNovedades" OnClick="btnVerNovedades_Click" Width="130px"
                                                    CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' Text="Ver Novedades" CssClass="btn8" /></ItemTemplate></asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-CssClass="gridIco"><ItemTemplate><cc1:ButtonGrid runat="server" ID="btnAgregarNovedades" OnClick="btnAgregarNovedades_Click" Width="100px"
                                                    CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' Text="+ Novedad" CssClass="btn8" /></ItemTemplate></asp:TemplateField>
                                    </Columns>
