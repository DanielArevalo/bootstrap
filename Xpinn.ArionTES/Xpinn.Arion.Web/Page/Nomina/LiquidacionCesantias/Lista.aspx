...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                         ...
                         <asp:BoundField DataField="liquido_interes" HeaderText="Liquido Int. Cesantias" ItemStyle-HorizontalAlign="Center" >
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>

                         <asp:BoundField DataField="liquido_cesantias" HeaderText="Liquido  Cesantias" ItemStyle-HorizontalAlign="Center" >
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
