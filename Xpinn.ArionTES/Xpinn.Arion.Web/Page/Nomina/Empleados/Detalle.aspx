                        ...
                        <tr>
                            <td class="tdI" colspan="3" style="width: 100%">
                                <asp:Panel ID="Panel4" runat="server" Width="110%">
                                    <table style="width: 100%; text-align: left;">
                                        <tr>
                                            <td style="text-align: left;">Edad <br style="font-size: x-small" />
                                            </td>
                                            <td style="text-align: left;">
                        ...
                        <tr>
                            <td class="tdI" colspan="3" style="width: 100%">
                                <asp:Panel ID="Panel5" runat="server" Width="110%">
                                    <table style="width: 100%; text-align: left;">
                                        <tr>
                                            <td style="text-align: left; height: 31px;">Rh</td>
                                            <td style="text-align: left; height: 31px;">
                                                <asp:DropDownList ID="ddlTipoSangre" runat="server" CssClass="textbox" Width="156px">
                                                   
                                                   
                                                     <asp:ListItem Value="O-">O- </asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td style="text-align: left; height: 31px; width: 171px;">Visa<asp:RadioButtonList ID="rblVisa" runat="server" CellPadding="0" CellSpacing="0" Height="22px" RepeatDirection="Horizontal" Style="font-size: small; text-align: left;" Width="139px">
                                                <asp:ListItem>S</asp:ListItem>
                                                <asp:ListItem Selected="True">N</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                            <td style="text-align: left; height: 31px;">
                                                Fecha Vencimiento Visa</td>
                                            <td style="text-align: left; height: 31px;">
                                                <asp:TextBox ID="txtFechavencvisa" runat="server" CssClass="textbox" MaxLength="10" Width="150px" />
                                                <asp:MaskedEditExtender ID="mskFechavencvisa" runat="server" AcceptNegative="Left" DisplayMoney="Left" ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" TargetControlID="txtFechavencvisa" />
                                                <asp:MaskedEditValidator ID="mevFechavencvisa" runat="server" ControlExtender="mskFechavencvisa" ControlToValidate="txtFechavencvisa" Display="Dynamic" EmptyValueBlurredText="Fecha No Valida" EmptyValueMessage="Fecha Requerida" ForeColor="Red" InvalidValueBlurredMessage="Fecha No Valida" InvalidValueMessage="Fecha No Valida" Style="font-size: x-small" TooltipMessage="Seleccione una Fecha" />
                                                <asp:CalendarExtender ID="txtFechavencvisa_CalendarExtender" runat="server" DaysModeTitleFormat="dd/MM/yyyy" Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtFechavencvisa" TodaysDateFormat="dd/MM/yyyy">
                                                </asp:CalendarExtender>
                                                &nbsp; </td>
                                            <td style="text-align: left; height: 31px;">
                                                &nbsp;</td>
                                        ...
                                        <tr>
                                            <td style="text-align: left; height: 31px;">Sexo</td>
                                            <td style="text-align: left; height: 31px;">
                                            ...
                                            <td style="text-align: left; height: 31px; width: 171px;">Pasaporte
                                                <asp:RadioButtonList ID="rblPasaporte" runat="server" CellPadding="0" CellSpacing="0" Height="22px" RepeatDirection="Horizontal" Style="font-size: small; text-align: left;" Width="139px">
                                                    <asp:ListItem>S</asp:ListItem>
                                                    <asp:ListItem Selected="True">N</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                            <td style="text-align: left; height: 31px;">Fecha Vencimiento Pasaporte</td>
                                            <td style="text-align: left; height: 31px;">
                                                <asp:TextBox ID="txtFechavencpasaporte" runat="server" CssClass="textbox" MaxLength="10" Width="150px" />
                                                <asp:MaskedEditExtender ID="txtFechavencpasaporte_MaskedEditExtender" runat="server" AcceptNegative="Left" DisplayMoney="Left" ErrorTooltipEnabled="True" Mask="99/99/9999" MaskType="Date" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" TargetControlID="txtFechavencpasaporte" />
                                                <asp:CalendarExtender ID="txtFechavencpasaporte_CalendarExtender" runat="server" DaysModeTitleFormat="dd/MM/yyyy" Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtFechavencpasaporte" TodaysDateFormat="dd/MM/yyyy">
                                                </asp:CalendarExtender>
                                                <asp:MaskedEditValidator ID="mevFechavencpasaporte" runat="server" ControlExtender="mskFechavencpasaporte" ControlToValidate="txtFechavencpasaporte" Display="Dynamic" EmptyValueBlurredText="Fecha No Valida" EmptyValueMessage="Fecha Requerida" ForeColor="Red" InvalidValueBlurredMessage="Fecha No Valida" InvalidValueMessage="Fecha No Valida" Style="font-size: x-small" TooltipMessage="Seleccione una Fecha" />
                                            </td>
                                            <td style="text-align: left; height: 31px;"></td>
                                            <td style="text-align: left; height: 31px;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left; height: 31px;">Estado Civil<br /> </td>
                                            <td style="text-align: left; height: 31px;">
                                            ...
                                            <td style="text-align: left; height: 31px; width: 171px;">&nbsp;&nbsp; Personas a Cargo </td>
                                            <td style="text-align: left; height: 31px;">
                                                <asp:TextBox ID="txtPersonasCargo" runat="server" CssClass="textbox" MaxLength="100" onkeypress="return isNumber(event)" Visible="true" Width="150px"></asp:TextBox>
