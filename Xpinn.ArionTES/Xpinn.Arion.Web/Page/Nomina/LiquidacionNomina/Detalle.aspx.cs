...
public partial class Detalle : GlobalWeb
{
    ...
    protected void btnAgregarNovedadModal_Click(object sender, EventArgs e)
    {
        ...
        if (ValidarModalNuevaNovedad())
        {
            ...
            if (esConceptoHorasExtras || (esConceptoHorasExtras && esCalculoEnCantidad))
            {
                ...
                HorasExtrasEmpleados horaExtraEmpleado = new HorasExtrasEmpleados();
                horaExtraEmpleado.codigoempleado = Convert.ToInt64(txtCodigoEmpleadoModal.Text);
                horaExtraEmpleado.codigopersona = Convert.ToInt64(txtCodigoEmpleadoModal.Text);
                horaExtraEmpleado.fecha = !string.IsNullOrWhiteSpace(txtFechaFin.Text) ? Convert.ToDateTime(txtFechaFin.Text) : default(DateTime);
                horaExtraEmpleado.consecutivo = 0;
                horaExtraEmpleado.codigonomina = !string.IsNullOrWhiteSpace(ddlTipoNomina.SelectedValue) ? Convert.ToInt64(ddlTipoNomina.SelectedValue) : default(long);
                horaExtraEmpleado.codigoconceptohoras = Convert.ToInt32(ddlConceptoModal.SelectedValue);
                horaExtraEmpleado.cantidadhoras = Convert.ToDecimal(txtValorModal.Text);
    ...
    void CtlMensajeGuardar_eventoClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (txtobservaciones.Text != "")
                liquidacion.observaciones = txtobservaciones.Text;
            else
    ...
    void ctlMensajeGuardarPrueba_eventoClick(object sender, EventArgs e)
    {
        ...
        {
            VerError("Error al guardar la liquidación de nómina, " + ex.Message);
        }
    }
    ...
    protected void btnImprimirDesprendibles_Click(object sender, EventArgs e)
    {
        ...
        dataTable.Columns.Add("Centro_costo");
        dataTable.Columns.Add("Copia");
    ...
    protected void btnImprimirPlanilla_Click(object sender, EventArgs e)
    {
        ...
        dataTable.Columns.Add("ValorColumnaNueve");
        dataTable.Columns.Add("ValorColumnaDiez");
        dataTable.Columns.Add("ValorColumnaOnce");
        dataTable.Columns.Add("Centro_costo");
        ...
        List<ParConceptosPlanillaLiq> listaConceptosNovenaColumna = null;
        if (NovenaColumna.esvisible == 1)
        {
            listaConceptosNovenaColumna = _liquidacionServices.ListarConceptosParametrizadosSegunColumna(9, Usuario);
        }

        ParColumnasPlanillaLiq DecimaColumna = _liquidacionServices.ConsultarParametrizacionColumnas(10, Usuario);
        List<ParConceptosPlanillaLiq> listaConceptosDecimaColumna = null;
        if (DecimaColumna.esvisible == 1)
        {
            listaConceptosDecimaColumna = _liquidacionServices.ListarConceptosParametrizadosSegunColumna(10, Usuario);
        }

        ParColumnasPlanillaLiq OnceavaColumna = _liquidacionServices.ConsultarParametrizacionColumnas(11, Usuario);
        List<ParConceptosPlanillaLiq> listaConceptosOnceavaColumna = null;
        if (OnceavaColumna.esvisible == 1)
        {
            listaConceptosOnceavaColumna = _liquidacionServices.ListarConceptosParametrizadosSegunColumna(11, Usuario);
        }


        // Recorro a todos los empleados que se liquidaron
        foreach (LiquidacionNominaDetalle empleado in listaEmpleadosLiquidados.OrderBy(x => x.codigocentrocosto).ToList())
        {
            // Hallo los conceptos que se liquidaron para este empleado
            var conceptosDelEmpleado = listaLiquidacionDetalle.Where(x => x.codigoempleado == empleado.codigoempleado).ToList();
            ...
            decimal valorNovenaColumna = 0;
            if (listaConceptosNovenaColumna != null)
            {
                valorNovenaColumna = conceptosDelEmpleado.Where(x => listaConceptosNovenaColumna.Any(y => y.codigoconcepto == x.codigoconcepto)).Sum(x => x.valorconcepto);
            }

            decimal valorDecimaColumna = 0;
            if (listaConceptosDecimaColumna != null)
            {
                valorDecimaColumna = conceptosDelEmpleado.Where(x => listaConceptosDecimaColumna.Any(y => y.codigoconcepto == x.codigoconcepto)).Sum(x => x.valorconcepto);
            }


            decimal valorOnceavaColumna = 0;
            if (listaConceptosOnceavaColumna != null)
            {
                valorOnceavaColumna = conceptosDelEmpleado.Where(x => listaConceptosOnceavaColumna.Any(y => y.codigoconcepto == x.codigoconcepto)).Sum(x => x.valorconcepto);
            }
            ...
            row[16] = _stringHelper.FormatearNumerosComoCurrency(valorNovenaColumna);
            row[17] = _stringHelper.FormatearNumerosComoCurrency(valorDecimaColumna);
            row[18] = _stringHelper.FormatearNumerosComoCurrency(valorOnceavaColumna);
            row[19] = liquidacionNomina.CENTRO_COSTO_NOM;
        ...
        ReportParameter[] param = new ReportParameter[]
        {
                ...
                new ReportParameter("NombreColumnaNueve", NovenaColumna.nombrecolumna),
                new ReportParameter("NombreColumnaDiez", DecimaColumna.nombrecolumna),
                new ReportParameter("NombreColumnaOnce", OnceavaColumna.nombrecolumna),
                ...
                new ReportParameter("pObservaciones", HttpUtility.HtmlDecode(vacios(txtobservaciones.Text)))
    ...
    void ConsultarLiquidacion()
    {
        ...
        if (liquidacionNomina.observaciones == ".")
        {
            liquidacionNomina.observaciones = " ";

        }
        txtobservaciones.Text = liquidacionNomina.observaciones.ToString();
    ...
    void ConstruirReporteDesprendibleNomina(DataTable dataTable, LiquidacionNominaDetalle empleado, List<LiquidacionNominaDetaEmpleado> listaPagos, List<LiquidacionNominaDetaEmpleado> listaDescuentos)
    {
        ...
        String aprobador = lstConsultar.aprobador.ToString();
        String revisor = lstConsultar.revisor.ToString();
        String reportedeprendible = lstConsultar.formato_desprendible.ToString();
        ...
        if (reportedeprendible == "1")
        {
            rvReporteDesprendible.LocalReport.ReportPath = @"Page\Nomina\LiquidacionNomina\DesprendibleNomina.rdlc";

        }
        if (reportedeprendible == "2")
        {
            rvReporteDesprendible.LocalReport.ReportPath = @"Page\Nomina\LiquidacionNomina\DesprendibleNomina1.rdlc";
    ...
    DataRow ConstruirDataRowDefaultDesprendibleDeNominaParaUnEmpleado(DataTable dataTable, LiquidacionNominaDetalle empleado, decimal totalValorPago, decimal totalValorDescuentos)
    {
        ...
        row[12] = liquidacionNomina.Fecha_ingreso.ToShortDateString();
        ...
        row[20] = pTexto;
        row[21] = liquidacionNomina.CENTRO_COSTO_NOM;
    ...
    protected void btnImprimirPagos_Click(object sender, EventArgs e)
    {
        List<LiquidacionNominaDetalle> listaEmpleadosLiquidados = ViewState[_viewStateLiquidacion] as List<LiquidacionNominaDetalle>;
        List<LiquidacionNominaDetaEmpleado> listaLiquidacionDetalle = ViewState[_viewStateLiquidacionDetalle] as List<LiquidacionNominaDetaEmpleado>;
        ...
        foreach (LiquidacionNominaDetalle empleado in listaEmpleadosLiquidados)
        {
            ...
            DataRow row = dataTable.NewRow();
            row[0] = empleado.identificacion_empleado;
            row[1] = empleado.nombre_empleado;
            row[2] = _stringHelper.FormatearNumerosComoCurrency(totalValorPago - totalValorDescuentos);
            row[3] = _stringHelper.FormatearNumerosComoCurrency(totalValorPago - totalValorDescuentos);
            row[4] = liquidacionNomina.CENTRO_COSTO_NOM;
        ...
        totalizadoValorPago = totalizadoValorPago - totalizadoValorDescuentos;
        ...
        rvReportePagos.LocalReport.EnableExternalImages = true;
        rvReportePagos.LocalReport.ReportPath = @"Page\Nomina\LiquidacionNomina\PlanillaPagos.rdlc";
        rvReportePagos.LocalReport.SetParameters(param);

        ReportDataSource rds = new ReportDataSource("PlanillaPagosDataSet", dataTable);
        rvReportePagos.LocalReport.DataSources.Clear();
        rvReportePagos.LocalReport.DataSources.Add(rds);
        rvReportePagos.LocalReport.Refresh();

        pnlReporte.Visible = true;
        rvReportePagos.Visible = true;
        rvReportePlanilla.Visible = false;
        rvReporteDesprendible.Visible = false;
    }
