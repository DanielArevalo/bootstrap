                    ...
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td style="height: 53px">
                                <asp:Label ID="lblObservaciones" runat="server" Text="Observaciones" Visible="true" />
                                &nbsp;<asp:TextBox ID="txtobservaciones" runat="server" CssClass="textbox" MaxLength="300" TextMode="MultiLine" Width="896px" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
        ...
        <asp:View runat="server" ID="viewImprimir">
            <asp:Panel ID="Panel1" runat="server">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="text-align: center; font-size: large;">
                            <asp:TextBox ID="txtCodigo" runat="server" Visible="false" Enabled="false" CssClass="textbox" onkeypress="return isNumber(event)" Width="15px" />
                             <asp:TextBox ID="txtusuariocreacion" runat="server" Visible="false" Enabled="false" CssClass="textbox" Width="15px"/>
                           <asp:Button ID="btnImprimirDesprendibles" runat="server" Height="30px" Text="Imprimir Desprendibles"
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnImprimirPagos" runat="server" CssClass="btn8" Height="30px" OStyle="margin-left: 10px" Text="Imprimir Reporte Pagos" OnClick="btnImprimirPagos_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td>
                            <asp:Panel runat="server" ID="pnlReporte" Visible="false">
                                ...
                                <rsweb:ReportViewer ID="rvReportePlanilla" runat="server" Font-Names="Verdana" Visible="false"
                                    Font-Size="8pt" InteractiveDeviceInfos="(Colección)"
                                    WaitMessageFont-Names="Verdana" WaitMessageFont-Size="10pt" Height="600px" Width="100%"></rsweb:ReportViewer>
                               <rsweb:ReportViewer ID="rvReportePagos" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" InteractiveDeviceInfos="(Colección)" Visible="false" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="10pt" Width="100%">
                                </rsweb:ReportViewer>
                            </asp:Panel>
                        </td>
                         <td>
            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="2" style="text-align: center">
                     ...
                     PagerStyle-CssClass      ="gridPager" PageSize="100" RowStyle-CssClass="gridItem" Style="font-size: small" Width="100%">
                            <Columns>
