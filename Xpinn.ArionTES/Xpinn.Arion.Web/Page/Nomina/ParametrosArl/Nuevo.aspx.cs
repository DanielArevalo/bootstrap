...
{
    ParametrosArlService service = new ParametrosArlService();
    ...
    void GuardarDatos()
    {
        try
        {
            Xpinn.Nomina.Services.ParametrosArlService cservice = new Xpinn.Nomina.Services.ParametrosArlService();
            Xpinn.Nomina.Entities.ParametrosArl entities = new Xpinn.Nomina.Entities.ParametrosArl();
            ...
            if (idObjeto == "")
            {
                ParametrosArl parametrosarl = cservice.CrearParametrosArl(entities, Usuario);
                entities.consecutivo = parametrosarl.consecutivo;
            }
            else
            {
                ParametrosArl parametrosarl = cservice.ModificarParametrosArl(entities, Usuario);
            }
    ...
    protected void ObtenerDatos()
    {
        try
        {
            ...
            entities = cservice.ConsultarParametrosArl(entities.consecutivo, (Usuario)Session["usuario"]);
