...
public partial class Lista : GlobalWeb
{
    ...
    void Actualizar()
    {
        try
        {
            ...
            List<LiquidacionPrima> lstLiquidacion = _liquidacionServices.ListarLiquidacionPrima(filtro, Usuario);
    ...
    string ObtenerFiltro()
    {
        ...
        if (!string.IsNullOrWhiteSpace(ddlSemestre.SelectedValue))
        {
            filtro += " and liq.SEMESTRE = " + ddlSemestre.SelectedValue;
        }
