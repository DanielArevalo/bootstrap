...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server"> 
         ...
         <table>
            ...
            <Table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="100%">
                    <tr>
                        <td> Código <br/>
                            <asp:TextBox ID="txtcodtiporetiro" runat="server" onkeypress="return isNumber(event)" CssClass="textbox"/>
                        </td>
                        <td> Tipo De Retiro Contrato <br />
                
                            <asp:DropDownList runat="server" ID="ddlTipoRetiroContrato" AppendDataBoundItems="true" CssClass="dropdown" Width="90%">
        ...
        <asp:GridView ID="gvContent" runat="server" 
                     ...
                     <Columns>
                        ...
                        <asp:BoundField DataField="descripciontiporetiro" HeaderText="Descripción Retiro" ItemStyle-HorizontalAlign="Center" />
                    </Columns>
