...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(CreditoServicio.CodigoProgramaModifi, "L");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                CargarValoresConsulta(pConsulta, CreditoServicio.CodigoProgramaModifi);
                if (Session[CreditoServicio.CodigoProgramaModifi + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    protected void btnConsultar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            GuardarValoresConsulta(pConsulta, CreditoServicio.CodigoProgramaModifi);
            Actualizar();
        }
    }
    ...
    protected void btnLimpiar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LimpiarValoresConsulta(pConsulta, CreditoServicio.CodigoProgramaModifi);
    }
    ...
    protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[CreditoServicio.CodigoProgramaModifi + ".id"] = id;
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(CreditoServicio.CodigoProgramaModifi, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    private void Actualizar()
    {
        try
        {
            ...
            lstConsulta = ReliquidacionServicio.ListarCredito((Usuario)Session["usuario"], filtro);
            ...
            Session.Add(CreditoServicio.CodigoProgramaModifi + ".consulta", 1);
        }
        catch (Exception ex)
        {
