...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(documentoservicio.CodigoPrograma, "L");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                CargarDllOficinas();
                CargarDllLineas();
                CargarValoresConsulta(pConsulta, documentoservicio.CodigoPrograma);
                if (Session[documentoservicio.CodigoPrograma + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    {
        Session.Remove(documentoservicio.CodigoPrograma + ".id");
    }
    ...
    protected void btnConsultar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            GuardarValoresConsulta(pConsulta, documentoservicio.CodigoPrograma);
            Actualizar();
        }
    }
    ...
    {
        LimpiarValoresConsulta(pConsulta, documentoservicio.CodigoPrograma);
    }
    ...
    protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[documentoservicio.CodigoPrograma + ".id"] = id;
    ...
    private void Actualizar()
    {
        try
        {
            ...
            lstConsulta = this.creditoservicio.ListarCreditoDocumRequeridos(ObtenerValores(), (Usuario)Session["usuario"], filtro);
