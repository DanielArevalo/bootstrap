...
partial class Lista : GlobalWeb
{
    ...
    //if(txtTipo.Text.Trim() != "")
        vBienesRaices.tipo = ddlTipoVehiculo.Text;
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            vBienesRaices.cod_persona = Convert.ToInt64(Session["CodCodeudor"].ToString());
            vBienesRaices.tipo = Convert.ToString(ddlTipoVehiculo.SelectedValue);
    ...
    protected void ObtenerDatos(String pIdObjeto)
    {
        try
        {
            ...
            if (vBienesRaices.tipo != null)
                ddlTipoVehiculo.SelectedValue = HttpUtility.HtmlDecode(vBienesRaices.tipo.ToString().Trim());
