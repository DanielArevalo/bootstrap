...
public partial class Page_FabricaCreditos_Solicitud_InformacionFinanciera_BalanceGeneralMicroempresa_Default : System.Web.UI.Page
{
    ...
    protected void btnAdelante_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            datosSolicitud.montosolicitado = 0;
            datosSolicitud.plazosolicitado = 0;
            datosSolicitud.cuotasolicitada = 0;
            datosSolicitud.tipocrdito = "0";
            datosSolicitud.periodicidad = 0;
            datosSolicitud.medio = 0;
            datosSolicitud = DatosSolicitudServicio.CrearSolicitud(datosSolicitud, (Usuario)Session["usuario"]);
            lblNumRadicacion.Text = datosSolicitud.numerosolicitud.ToString();
            mvBalanceGeneralMicroempres.ActiveViewIndex = 1;
        }
