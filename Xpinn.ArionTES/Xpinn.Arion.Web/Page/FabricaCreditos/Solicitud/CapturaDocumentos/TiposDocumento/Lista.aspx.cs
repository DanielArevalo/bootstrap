...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(TiposDocumentoServicio.CodigoPrograma, "L");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                CargarValoresConsulta(pConsulta, TiposDocumentoServicio.CodigoPrograma);
                if (Session[TiposDocumentoServicio.CodigoPrograma + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    {
        GuardarValoresConsulta(pConsulta, TiposDocumentoServicio.CodigoPrograma);
    ...
    {
        LimpiarValoresConsulta(pConsulta, TiposDocumentoServicio.CodigoPrograma);
    }
    ...
    protected void gvLista_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(TiposDocumentoServicio.CodigoPrograma + "L", "gvLista_RowDataBound", ex);
        }
    }
    ...
    protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[TiposDocumentoServicio.CodigoPrograma + ".id"] = id;
    ...
    protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(TiposDocumentoServicio.CodigoPrograma, "gvLista_RowDeleting", ex);
        }
    }
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(TiposDocumentoServicio.CodigoPrograma, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    private void Actualizar()
    {
        try
        {
            ...
            lstConsulta = TiposDocumentoServicio.ListarTiposDocumento(ObtenerValores(), (Usuario)Session["usuario"]);
    ...
    private Xpinn.FabricaCreditos.Entities.TiposDocumento ObtenerValores()
    {
