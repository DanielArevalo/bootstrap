...
partial class Nuevo : GlobalWeb
{
    ...
    protected void CargarOpciones(string sidPerfil, string sidModulo)
    {
        ...
        lstAccesos = OpcionesServicio.ListarOpcionesModulo(idPerfil, Convert.ToInt64(sidModulo), (Usuario)Session["Usuario"]);
    ...
    protected void btnGrabar_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            {
                OpcionesCredito pAcceso = new OpcionesCredito();
    ...
    protected void gvLista_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //Boolean seleccionado = e.Row.Cells[2].Text);
    ...
    private void CargarModulo()
    {
        try
        {
            ...
            lstModulo = OpcionesServicio.ListarModulo(null, (Usuario)Session["usuario"]);     
