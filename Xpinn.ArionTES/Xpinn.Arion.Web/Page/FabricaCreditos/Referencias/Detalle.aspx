<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Detalle.aspx.cs" Inherits="Detalle" Title=".: Xpinn - Referencia :." %>
    ...
    <table border="0" cellpadding="5" cellspacing="0" width="100%" >
                               ...
                               <Columns>
                                   ...
                                   <asp:BoundField DataField="Valor" HeaderText="Valor" />
                                    <asp:TemplateField HeaderText="Check">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkValidar" runat="server" enabled="false"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                               </Columns>
                           </asp:GridView>
                   ...
                   <tr>
                       ...
                       <asp:TextBox ID="txtDetalleRef" runat="server" CssClass="textbox" MaxLength="128" 
                               Height="120px" TextMode="MultiLine" Width="350px" Enabled="False" />
                           <br />
                       </td>
