...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(destinServicio.CodigoPrograma, "L");
    ...
    {
        Session.Remove(destinServicio.CodigoPrograma + ".id");
        GuardarValoresConsulta(pConsulta, destinServicio.CodigoPrograma);
    ...
    {
        LimpiarValoresConsulta(pConsulta, destinServicio.CodigoPrograma);
    }
    ...
    private void Actualizar()
    {
        try
        {
            List<Xpinn.FabricaCreditos.Entities.Destinacion> lstConsulta = new List<Xpinn.FabricaCreditos.Entities.Destinacion>();
            lstConsulta = destinServicio.ListarDestinacion(ObtenerValores(), (Usuario)Session["usuario"]);
