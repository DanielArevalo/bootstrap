...
{    
    ...
    protected void Page_PreInit(object sender, System.EventArgs e)
    {
        try
        {
            VisualizarOpciones(DatosClienteServicio.CodigoProgramaMod, "D");
        ...
        {
            BOexcepcion.Throw(DatosClienteServicio.CodigoProgramaMod, "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(DatosClienteServicio.CodigoProgramaMod, "Page_Load", ex);
        }
    }
    ...
    protected void gvListaTitulares_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[DatosClienteServicio.CodigoPrograma + ".id"] = identificacion;
        Session["Origen"] = "MDCL"; 
