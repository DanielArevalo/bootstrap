...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(AvanServicios.CodigoProgramaModCupo, "L");
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AvanServicios.CodigoProgramaModCupo, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    protected void gvLista_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Session[AvanServicios.CodigoProgramaModCupo + ".id"] = id;
    ...
    private void Actualizar()
    {
        try
        {
            ...
            Session.Add(AvanServicios.CodigoProgramaModCupo + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(AvanServicios.CodigoProgramaModCupo, "Actualizar", ex);
        }
    }
