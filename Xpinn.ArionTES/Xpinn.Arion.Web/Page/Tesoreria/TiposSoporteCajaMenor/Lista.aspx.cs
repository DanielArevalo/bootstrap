...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        try
        {
            VisualizarOpciones(TipSopCajServicio.CodigoPrograma, "L");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ListaPlanCuentas();
                CargarValoresConsulta(pConsulta, TipSopCajServicio.CodigoPrograma);
                if (Session[TipSopCajServicio.CodigoPrograma + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
    ...
    {
        GuardarValoresConsulta(pConsulta, TipSopCajServicio.CodigoPrograma);
    ...
    {
        LimpiarValoresConsulta(pConsulta, TipSopCajServicio.CodigoPrograma);
    }
    ...
    protected void gvLista_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(TipSopCajServicio.CodigoPrograma + "L", "gvLista_RowDataBound", ex);
        }
    }
    ...
    protected void gvLista_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session[TipSopCajServicio.CodigoPrograma + ".id"] = id;
    ...
    protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            TipSopCajServicio.EliminarTipSopCaj(id, (Usuario)Session["usuario"]);
            Actualizar();
        }
        ...
        {
            BOexcepcion.Throw(TipSopCajServicio.CodigoPrograma, "gvLista_RowDeleting", ex);
        }
    }
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(TipSopCajServicio.CodigoPrograma, "gvLista_PageIndexChanging", ex);
        }
    }
    ...
    private void Actualizar()
    {
        try
        {
            List<Xpinn.Tesoreria.Entities.TipSopCaj> lstConsulta = new List<Xpinn.Tesoreria.Entities.TipSopCaj>();
            lstConsulta = TipSopCajServicio.ListarTipSopCaj(ObtenerValores(), (Usuario)Session["usuario"]);
            ...
            Session.Add(TipSopCajServicio.CodigoPrograma + ".consulta", 1);
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(TipSopCajServicio.CodigoPrograma, "Actualizar", ex);
        }
    }

    private Xpinn.Tesoreria.Entities.TipSopCaj ObtenerValores()
    {
        Xpinn.Tesoreria.Entities.TipSopCaj vTipSopCaj = new Xpinn.Tesoreria.Entities.TipSopCaj();

        if (txtTipSopCaj.Text.Trim() != "")
