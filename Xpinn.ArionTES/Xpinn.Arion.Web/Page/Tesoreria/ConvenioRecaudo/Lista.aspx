<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Lista.aspx.cs" Inherits="Lista" Title=".: Xpinn - ConvenioRecaudo :." %>
        ...
        <tr>
            <td>
                <asp:GridView ID="gvLista" runat="server" Width="100%" AutoGenerateColumns="False" OnRowDataBound="gvLista_RowDataBound" OnRowDeleting="gvLista_RowDeleting" 
                    ...
                    PageSize="20" HeaderStyle-CssClass="gridHeader" PagerStyle-CssClass="gridPager" RowStyle-CssClass="gridItem"  DataKeyNames="cod_convenio" >
                    <Columns>
                        <asp:BoundField DataField="cod_convenio" HeaderStyle-CssClass="gridColNo" 
                        ...
                        <asp:BoundField DataField="cod_convenio" HeaderText="Código Convenio">
                            <ItemStyle HorizontalAlign="Left" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="nombre_convenio" HeaderText="Nombre Convenio" >
