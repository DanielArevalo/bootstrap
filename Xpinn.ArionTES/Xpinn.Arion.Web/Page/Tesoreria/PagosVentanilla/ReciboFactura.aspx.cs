...
public partial class Factura : GlobalWeb
{
    ...
    protected void ObtenerDatos()
    {
        ...
        try
        {
            ...
            if (operacion.cod_persona != null)
                people.cod_persona = long.Parse(operacion.cod_persona);
            else
                people.cod_persona = Convert.ToInt64(Session[Usuario.codusuario + "cod_persona"]);
            ...
            lblTipo_comp.Text = operacion.tipo_comp.ToString() + "-" + operacion.tipo_comp_desc.ToString();
            lblNum_comp.Text = operacion.num_comp.ToString();
            ...
            people.cod_ope = cod_ope;
            people = peopleServicio.ConsultarValorCheque(people, (Usuario)Session["usuario"]);
            lblCheque.Text = people.valor_total_cheques.ToString("N0");
            if (!string.IsNullOrEmpty(people.referencia))
            txtObservaciones.Text +=  " Cheque: " + people.referencia;
            people.referencia = null;
            ...
            if (!string.IsNullOrEmpty(people.referencia))
                txtObservaciones.Text +=  " Baucher: " + people.referencia;
    ...
    {
        Session.Remove(Usuario.codusuario + "codOpe");
    ...
    protected void GenerarReporte()
    {
        ...
        param[23] = new ReportParameter("Num_Comp", lblNum_comp.Text);
        param[24] = new ReportParameter("Tipo_Comp", lblTipo_comp.Text);
