                    ...
                    <td>
                        <asp:Panel ID="pConsulta" runat="server">
                            <table id="tbCriterios" border="0" cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td class="tdI" style="width: 439px; text-align: left">Código Opecración<br />
                                ...
                                <tr>
                                    ...
                                    <td class="tdI" style="text-align: left" colspan="1">
                                        <asp:DropDownList ID="ddlMotivoAnulacion" runat="server" Width="244px"
                                            CssClass="dropdown" Height="30px">
                                        </asp:DropDownList>
                                    </td>
                                      <td style="text-align: left;" colspan="3">
                                        <div runat="server" ID="ConsultarDocumentos"></div>
                                    </td>
                                    <td class="tdD">&nbsp;</td>
                                    <td class="tdD">&nbsp;</td>
                                    <td class="tdD">&nbsp;</td>
    ...
    <asp:Panel ID="panelActividadReg" runat="server" BackColor="White" Style="text-align: right" BorderWidth="1px" Width="500px">
        <div id="popupcontainer" style="width: 500px">
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="3" style="text-align: center">Esta Seguro de Realizar esta Anulación ?
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;
