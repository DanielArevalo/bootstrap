    ...
    <asp:MultiView ID="mvOperacion" runat="server">
        <asp:View ID="vwOperacion" runat="server">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: left; width: 10%">Valor Total
                    </td>
            ...
            <asp:UpdatePanel ID="panelgrilla" runat="server">
                <ContentTemplate>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left">
                                <strong>Aportes a Cruzar</strong><br />
                                <asp:GridView ID="gvAportes" runat="server" AllowPaging="True" OnRowDataBound="gvAportes_RowDataBound"
                                    AutoGenerateColumns="False" DataKeyNames="numero_aporte" GridLines="Horizontal"
                                    PageSize="20" ShowHeaderWhenEmpty="True" Width="80%" Font-Size="X-Small">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="cuota" HeaderText="Valor Cuota" DataFormatString="{0:c}" />
                                        ...
                                        <asp:TemplateField HeaderText="Valor a Aplicar">
                                            <ItemTemplate>
                                                <uc1:decimalesGridRow ID="txtValorAporte" runat="server" CssClass="textbox" Width_="80"
                                                    MaxLength="12" AutoPostBack_="True" TipoLetra="X-Small"></uc1:decimalesGridRow>
                                                <asp:TextBox ID="txtValorApo" runat="server" Visible="false" />
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="gridIco" />
                                        </asp:TemplateField>
                                    </Columns>
                        ...
                        <tr>
                            <td style="text-align: left; width: 10%">Valor Aportes
                            </td>
                            <td style="text-align: left; width: 90%">
                                <asp:TextBox ID="txtValTotalAporte" runat="server" CssClass="textbox" Enabled="false"
                                    Width="120px" Style="text-align: right"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
        ...
        <asp:View ID="mvFinal" runat="server">
            <asp:Panel ID="PanelFinal" runat="server">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="text-align: center; font-size: large;">
                            <asp:Label ID="lblMensajeGrabar" runat="server" Text="Cruce Generado Correctamente"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-size: large;">
