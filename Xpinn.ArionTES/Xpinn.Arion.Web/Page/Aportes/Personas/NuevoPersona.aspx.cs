...
public partial class NuevoPersona : GlobalWeb
{
    ...
    private void CalcularEdad(int valor)
    {
        try
        {
            ...
            else if (txtfechaNac_Cony.Text != "" && valor == 2)
            {
                ...
                if (Convert.ToInt64(txtEdad_Cony.Text) > 0)
                {
                    if (Convert.ToInt64(txtEdad_Cony.Text) < Convert.ToInt64(pGeneral.valor))
                        VerError("La persona debe ser mayor de edad");
                }
            }
        }
            ...
            if (validarDatos())
            {
                ...
                else if (editar == true)                   
                {
                    if (chkPEPS.Checked && !panelRiesgo.Visible)
                    {
                        ...
                        //txtResultadoOFAQ.Text = intRiesgo.ConsultarPersona(txtIdentificacionRiesgo.Text, txtNombreRiesgo.Text);
                    }
                    else
                    { 
                        Navegar("../Afiliaciones/Lista.aspx");
    ...
    private void GuardarConyuge()
    {
        ...
        vPersona1.fechaexpedicion = txtFechaExp_Cony.Text != null ? Convert.ToDateTime(txtFechaExp_Cony.Texto) : DateTime.MinValue;
    ...
    {
        //if (ddlOcupacion.SelectedValue != "7")
        //    acoInformacionLaboral.Visible = true;
        //else
