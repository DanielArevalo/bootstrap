<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Economica.aspx.cs" Inherits="NuevoPersona" Title=".: Expinn - Personas :."  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:Panel ID="panelDAtaGeneral" runat="server">
				    ...
				    <div class="wrap">					    
                            <ul class="tabs header-tabs">
                                ...
                                <li id="liBeneficiarios" title="InfoBenefi">
                                    <asp:Button Text="Inf. beneficiarios" runat="server" ID="btnTab3" class="tab" OnClientClick="saltarRequeridos()" OnClick="btnTab3_Click" />    
                                </li>
                                <li id="lilEconomica" title="InfoEconomi">
                                    <asp:Button Text="Inf. económica" runat="server" ID="btnTab4" class="tab active" OnClick="btnTab4_Click" />
                                </li>
        ...
        <div id="contenido">
                    ...
                    <table style="width: 100%; padding-top: 15px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                ...
                                <asp:TextBox ID="txtsueldo_soli" runat="server" CssClass="textbox numeric required" onkeyup="TotalizarIngresosSoli(this)"
                    ...
                    <asp:Button ID="btnBienesActivos" runat="server" CssClass="btn8" TabIndex="28" OnClick="InicializarModal" OnClientClick="cphMain_LinkButton1.click();" UseSubmitBehavior="false" Text="+ Adicionar Detalle" />
                    <asp:GridView ID="gvBienesActivos" runat="server" 
                        ...
                        OnRowCommand="gvBienesActivos_OnRowCommand" OnRowEditing="gvBienesActivos_RowEditing" OnRowDeleting="gvBienesActivos_RowDeleting" Width="90%">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="gvBienesActivos" />
