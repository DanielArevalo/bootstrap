...
public partial class NuevoPersona : GlobalWeb
{
    ...
    #region eventos de carga de datos
        ...
        if (Session[Usuario.codusuario + "cod_per"] != null)
        {
            ...
            if (Entidad != null)
            {
                if (Entidad != null)
                {
                    ...
                    if (Entidad.codestadocivil != null && (Entidad.codestadocivil == 1 || Entidad.codestadocivil == 3))
                    {
                        UpdConyugue.Visible = true;
                        // Conyugue  
    ...
    protected void txtIdentificacionE_TextChanged(object sender, EventArgs e)
    {
        try
        {
            if (!string.IsNullOrEmpty(txtIdent_cony.Text))
            {
                Persona1 Entidad = new Persona1();
                lblerror.Text = ("");
            ...
            {
                    if(Entidad.cod_persona.ToString() != Session[Usuario.codusuario + "cod_per"].ToString())
                    {
                        ...
                        else
                {
                    ...
                    {
                        lblerror.Text = "La identificación es la misma que la del asociado"; 
                    }
            }
    ...
    private bool almacenarDatos()
    {
        ...
        if (Session[Usuario.codusuario + "cod_per"] != null)
        {
            ...
            if (!result)
            {
                ...
                {
                    lblerror.Text = ("Error al modificar los datos de beneficiarios. " + pError);
                    return false;
                }
            }
            else
