...
public partial class Page_Aportes_Personas_Tabs_Personal : GlobalWeb // System.Web.UI.Page
{
    ...
    public void btnGuardarEconomica_click(object sender, EventArgs e)
    {
        Usuario pUsuario = (Usuario)Session["usuario"];
        Persona1 Entidad = new Persona1();
        ...
        if (Session[Usuario.codusuario + "cod_per"] != null)
        {
            ...
            catch (Exception ex)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), "Error", "alert('Error al modificar los datos de la información Económica.')", true);
                return;
            }
        }
        else
