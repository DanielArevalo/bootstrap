        ...
        <table cellpadding="5" cellspacing="0" style="width: 80%; margin-right: 0px;">
            ...
            <tr>
                <td style="height: 15px; text-align: left; width: 150px;">
                    &nbsp;</td>
                <td style="height: 15px; text-align: left; width: 119px;">
                    <asp:DropDownList ID="ddlLineaAportes" runat="server"
                         AppendDataBoundItems="true" CssClass="textbox" Visible="False" Width="358px">
                        <asp:ListItem Value="0">Seleccione Un Item</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td style="text-align: left; height: 15px; width: 99px;">
        ...
        <tr>
            <td>
                <asp:GridView ID="gvLista" runat="server" Width="80%" AutoGenerateColumns="False"
                    ...
                    OnRowDataBound="gvLista_RowDataBound" DataKeyNames="numero_aporte" Style="font-size: xx-small">
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="gridIco">
                            <HeaderStyle CssClass="gridIco"></HeaderStyle>
                        </asp:TemplateField>
                        <asp:BoundField DataField="numero_aporte" HeaderText="No.Cuenta">
                            <ItemStyle HorizontalAlign="Left" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="cod_linea_aporte" HeaderText="Línea">
                        ...
                        <asp:BoundField DataField="intereses" HeaderText="Vr.Provision Interés">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="tasa_interes" HeaderText="Tasa Interes" DataFormatString="{0:n2}">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
