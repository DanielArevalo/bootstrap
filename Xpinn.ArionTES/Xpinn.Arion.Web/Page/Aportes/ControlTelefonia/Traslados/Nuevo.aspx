                    ...
                    <table style="width: 740px; text-align: center">
                        ...
                        <tr>
                            <td style="text-align: left; width: 246px">Titular<br />
                                ...
                                <asp:TextBox ID="txtIdPersona" runat="server" CssClass="textbox" AutoPostBack="true"
                                    Width="80%" OnTextChanged="txtIdPersona_TextChanged"  Enabled="false"/>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; width: 185px">Forma de Pago<br />
                                <asp:DropDownList ID="ddlFormaPago" runat="server" AutoPostBack="true" CssClass="textbox" OnSelectedIndexChanged="ddlFormaPago_SelectedIndexChanged" Width="80%"  Enabled="false"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: center; width: 185px">
                                ...
                                <asp:DropDownList ID="ddlEmpresa" runat="server" CssClass="textbox" Width="80%" Enabled="false">
                                </asp:DropDownList>
                            </td>
                        </tr>

                        <tr>
                            <td style="text-align: left; width: 246px">Nuevo Titular<br />
                                <asp:TextBox ID="txtCodPersona2" runat="server" CssClass="textbox" ReadOnly="True"
                                    Width="50px" Visible="false" />
                                <asp:TextBox ID="txtIdPersona2" runat="server" CssClass="textbox" AutoPostBack="true"
                                    Width="80%" OnTextChanged="txtIdPersona_TextChanged2" />
                                <asp:FilteredTextBoxExtender ID="fte1212" runat="server" TargetControlID="txtIdPersona2"
                                    FilterType="Custom, Numbers" ValidChars="-" />
                                <asp:Button ID="btnConsultaPersonas2" runat="server" CssClass="btn8" Height="26px"
                                    OnClick="btnConsultaPersonas_Click2" Text="..." />
                            </td>
                            <td style="text-align: left; width: 370px" colspan="2">Nombre Nuevo Titular<br />
                                <uc1:ListadoPersonas ID="ctlBusquedaPersonas2" runat="server" OneventotxtIdentificacion_TextChanged="txtIdPersona_TextChanged2" />
                                <asp:TextBox ID="txtNomPersona2" runat="server" CssClass="textbox" ReadOnly="True"
                                    Width="350px" />
                                <asp:RequiredFieldValidator ID="rfvEncargado2" runat="server" ControlToValidate="txtNomPersona2"
                                    Display="Dynamic" ErrorMessage="Seleccione encargado" ForeColor="Red" InitialValue="0"
                                    Style="font-size: xx-small" ValidationGroup="vgGuardar" />
                            </td>
                        ...
                        <tr>
                            <td style="text-align: center; width: 185px">Forma de Pago<br />
                                <asp:DropDownList ID="ddlFormaPago2" runat="server" AutoPostBack="true" CssClass="textbox" OnSelectedIndexChanged="ddlFormaPago_SelectedIndexChanged2" Width="80%" />
                            </td>
                            <td style="text-align: center; width: 185px">
                                <asp:Label ID="lblEmpresa2" runat="server" Text="Empresa Nuevo Titular"></asp:Label><br />
                                <asp:DropDownList ID="ddlEmpresa2" runat="server" CssClass="textbox" Width="80%">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="txtIdentificacionTitu2" runat="server" CssClass="textbox" ReadOnly="True"
                                    Width="50px" Visible="false" />
                            </td>
                            <td>
                                <asp:TextBox ID="txtNombreTit2" runat="server" CssClass="textbox" ReadOnly="True"
                                    Width="50px" Visible="false" />
                            </td>
                        </tr>
