            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <table style="width: 740px; text-align: center">
                        <tr>
                            <td style="text-align: left; width: 140px" colspan="4">Fec. Cancelación<br />
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; width: 185px">Saldo Servicio Fijo<br />
                                <asp:TextBox ID="txtsaldoserfij" runat="server" CssClass="textbox" Width="80%" Style="text-align: right"  Enabled="false"/>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtsaldoserfij"
                                    FilterType="Custom, Numbers" ValidChars="." />
                            </td>
                            <td style="text-align: center; width: 185px">Saldo Servicio Adicional<br />
                                <asp:TextBox ID="txtsaldoseradi" runat="server" CssClass="textbox" Width="80%" Style="text-align: right" Enabled="false"/>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="txtsaldoseradi"
                                    FilterType="Custom, Numbers" ValidChars="." />
                            </td>
                        </tr>
                        <tr>
        ...
        <asp:View ID="vwFinal" runat="server">
            <asp:Panel ID="PanelFinal" runat="server">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="text-align: center; font-size: large; color: Red">Cancelación
