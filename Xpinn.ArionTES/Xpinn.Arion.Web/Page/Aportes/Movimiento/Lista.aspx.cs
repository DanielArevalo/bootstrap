...
partial class Lista : GlobalWeb
{
    ...
    protected void Page_PreInit(object sender, EventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AporteServicio.CodigoProgramaMov, "Page_PreInit", ex);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                CargarValoresConsulta(pConsulta, AporteServicio.CodigoProgramaMov);
                if (Session[AporteServicio.CodigoProgramaMov + ".consulta"] != null)
                    Actualizar();
            }
        }
        catch (Exception ex)
        {
            BOexcepcion.Throw(AporteServicio.CodigoProgramaMov, "Page_Load", ex);
        }
    }
    ...
    {
        GuardarValoresConsulta(pConsulta, AporteServicio.CodigoProgramaMov);
        Actualizar();
    }

    protected void btnLimpiar_Click(object sender, ImageClickEventArgs e)
    {
        LimpiarValoresConsulta(pConsulta, AporteServicio.CodigoProgramaMov);
        txtNombre.Text = "";
        txtNumAporte.Text = "";
    ...
    protected void gvLista_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AporteServicio.CodigoProgramaMov + "L", "gvLista_RowDataBound", ex);
        }
    }
    ...
    protected void gvLista_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            BOexcepcion.Throw(AporteServicio.CodigoProgramaMov, "gvLista_PageIndexChanging", ex);
        }
    }
