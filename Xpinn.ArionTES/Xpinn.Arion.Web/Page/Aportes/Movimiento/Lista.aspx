...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:Panel ID="pConsulta" runat="server">
        <table cellpadding="3" cellspacing="0" style="width: 92%">
            <tr>
            ...
            <tr>
                ...
                <td style="height: 15px; text-align: left;" colspan="2">Nombre<br />
            ...
            <td style="text-align: left">
                <asp:GridView ID="gvLista" runat="server" Width="90%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="saldo" HeaderText="Saldo Total" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Width="140px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="cuota" HeaderText="Valor Cuota" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Width="140px" />
                        </asp:BoundField>
