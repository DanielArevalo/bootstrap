<%@ Page Language="C#" MasterPageFile="~/General/Master/site.master" AutoEventWireup="true" CodeFile="Detalle.aspx.cs" Inherits="Detalle" Title=".: Xpinn - TipoLiquidacion :." %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    <table border="0" cellpadding="5" cellspacing="0" width="100%" >
        <tr>
            ...
            <asp:TextBox ID="txtTipoLiquidacion" runat="server" CssClass="textbox" 
        ...
        <tr>
            <td class="tdI" style="text-align:left" colspan="2">
                ...
                <asp:DropDownList ID="ddlPeriodicidad" runat="server" CssClass="dropdown" 
                    Height="26px" Width="240px" AutoPostBack="True" Enabled="False" >
        ...
        <tr>
            <td class="tdI" style="text-align:left; height: 58px;" colspan="2">
                ...
                <asp:DropDownList ID="ddlTipoSaldoBase" runat="server" CssClass="dropdown" 
                    Height="26px" Width="240px" Enabled="False">
        ...
        <tr>
            <td class="tdI" style="text-align:left" colspan="2">
                ...
                <asp:DropDownList ID="ddlLineaBase" runat="server" Height="26px" 
                    Width="240px" CssClass="dropdown" Enabled="False">                  
                </asp:DropDownList>
            </td>
            <td class="tdD">
            </td>
