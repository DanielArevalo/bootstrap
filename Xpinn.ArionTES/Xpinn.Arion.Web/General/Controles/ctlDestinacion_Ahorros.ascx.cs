...
public partial class ctlDestinacionAhorros : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ddlDestinacion.DataSource = destinacionServicio.ListarDestinacion_Ahorros(destinacion, pUsuario);
