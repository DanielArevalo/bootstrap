<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlseleccionmultipledropdown.ascx.cs" Inherits="General_Controles_ctlseleccionmultipledropdown" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:UpdatePanel ID="upListado" runat="server">
    <ContentTemplate>
        <asp:HiddenField ID="hfValue" runat="server" Visible="false" />
        <asp:TextBox ID="txtDato" runat="server" Width="145px" ReadOnly="True" CssClass="textbox"></asp:TextBox>
