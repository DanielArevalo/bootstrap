<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlBusquedaRapidaVentEmergente.ascx.cs" Inherits="BusquedaRapidaVentEmergente"  Debug="true" %>
...
<asp:Panel ID="panelBusquedaRapida" runat="server" BackColor="White" Style="text-align: right; position: fixed ;top:0px ; left:0px" 
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%" border="0">
            ...
            <tr style="background-color:#DEDFDE">
                <td style="font-size: xx-small; text-align: left;">
                    <asp:TextBox ID="txtCod" runat="server" Width="45px" Font-Size="XX-Small"></asp:TextBox>
                </td>
                <td style="font-size: xx-small; text-align: left;">
