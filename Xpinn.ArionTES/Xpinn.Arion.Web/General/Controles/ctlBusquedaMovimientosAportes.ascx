<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlBusquedaMovimientosAportes.ascx.cs" Inherits="BusquedaMovimientos"  Debug="true" %>
...
<asp:Panel ID="panelBusquedaRapida" runat="server" BackColor="White" Style="text-align: right; position: relative;top:auto;left:auto" 
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="text-align:center;" width="95%">
                    Listado de Movimientos de Aportes</td>
    ...
    <asp:Panel ID="PanelListadoPersonas" runat="server" BackColor="White" Width="100%" >
        <asp:HiddenField ID="hfNumAporte" runat="server" Visible="False" />
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%" border="0">
            <tr style="background-color:#DEDFDE">
                ...
                <td style="font-size: xx-small; text-align: left; width: 75px">
                    Num. Aporte</td>
                <td style="font-size: xx-small; text-align: left; width: 75px">
                    Código</td>
                <td style="font-size: xx-small; text-align: left; width: 100px">
                    Identificación</td>
                <td style="font-size: xx-small; text-align: left; width: 260px">
                    Nombres</td>
            ...
            <tr style="background-color:#DEDFDE">
                <td style="font-size: xx-small; text-align: left;">
                    <asp:TextBox ID="txtNumAporte" runat="server" Width="90%" Font-Size="XX-Small"></asp:TextBox>
                </td>
                <td style="font-size: xx-small; text-align: left;">
                    <asp:TextBox ID="txtCod" runat="server" Width="90%" Font-Size="XX-Small"></asp:TextBox>                    
                </td>
                <td style="font-size: xx-small; text-align: left;">
                <asp:TextBox ID="txtIde" runat="server" Width="95px" Font-Size="XX-Small"></asp:TextBox>                    
                </td>
                <td style="font-size: xx-small; text-align: left;">
                ...
                <td colspan="6" style="background-color:#DEDFDE">
                    <asp:GridView ID="gvPersonas" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField ApplyFormatInEditMode="True" DataField="numero_aporte" HeaderText="Num. Aporte">
                            ...
                            <asp:BoundField DataField="tipo_identificacion" HeaderText="Tipo Id.">
