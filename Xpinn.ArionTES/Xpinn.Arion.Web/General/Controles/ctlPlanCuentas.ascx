<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlPlanCuentas.ascx.cs" Inherits="ctlPlanCuentas" %>
                ...
                <td colspan="6" style="background-color:#DEDFDE">
                    <asp:GridView ID="gvPlanCuentas" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField ApplyFormatInEditMode="True" DataField="cod_cuenta" HeaderText="Cód.Cuenta">
