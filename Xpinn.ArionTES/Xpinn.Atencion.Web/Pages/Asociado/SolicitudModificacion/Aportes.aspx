<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Aportes.aspx.cs" Inherits="Aportes" %>
                                    ...
                                    <div style="overflow: scroll; width: 100%; max-height: 350px;">
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton Visible='<%# Eval("cuota").ToString().Trim() == "0" ? false:true %>' ID="btnModificar" runat="server" CssClass="btn btn-primary" style="margin:1px; padding: 0px 2px" CommandName="Edit"
                                                ...
                                                <asp:BoundField HeaderText="Nro Ref" DataField="cod_linea_aporte" Visible="false" />
                                                <asp:BoundField HeaderText="Descripción" DataField="nom_linea_aporte" ItemStyle-HorizontalAlign="Center" />
                                                ...
                                                <asp:BoundField HeaderText="Prox pago" DataField="fecha_proximo_pago" DataFormatString="{0:d}">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="Vencido" DataField="valor_a_pagar" DataFormatString="{0:C0}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
