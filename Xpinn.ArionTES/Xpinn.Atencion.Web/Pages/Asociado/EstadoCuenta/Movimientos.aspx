<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Movimientos.aspx.cs" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-group">
                    ...
                    <table class="col-sm-12 tableNormal">
                        <tr>
                            <td style="display: flex; justify-content: space-between">
                                ...
                                <a class="btn btn-primary" href="Detalle.aspx" style="height: fit-content;">Volver</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <tr>
                <td>
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnPlanPagos" Text="plan Pagos" CssClass="btn btn-primary" runat="server" OnClick="btnConsultarPlanPagos_Click" visible="false"/>
                        </div>
                    </div>
                </td>
            </tr>
        ...
        <asp:Panel runat="server" ID="pnlAvances">            
            <asp:GridView ID="gvAvances" runat="server" Width="100%" CssClass="table table-striped"
                          ...
                          <Columns>                             
                            ...
                            <asp:BoundField DataField="Estado" HeaderText="Estado">  <ItemStyle HorizontalAlign="center" /></asp:BoundField>                                     
                                ...
                                <asp:BoundField DataField="Tasa" HeaderText="Tasa" DataFormatString="{0:N}%"><ItemStyle HorizontalAlign="Right" /></asp:BoundField>
