<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Convenios.aspx.cs" Inherits="Convenios" %>
    ...
    <div style="text-align: center">
        ...
        <asp:Panel ID="pnlDatos" Visible="false" runat="server" Style="text-align: left; margin: auto auto" Width="50%">
            <div class="modal-content">
                ...
                <div class="col-sm-12">
                    <asp:Panel runat="server" ID="pnlAdjunto" Visible="false">
                        <div class="col-sm-4 text-left">
                ...
                <div class="col-sm-12">
                    <asp:TextBox runat="server" ID="txtLineaCred" ReadOnly="true" Visible="false"></asp:TextBox>
                    <br />
                </div>                
        ...
        <asp:Panel ID="panelFinal" runat="server" Visible="false">
            <div class="col-xs-12">
                ...
                <div class="col-lg-10 col-md-12 col-xs-12" style="margin-top: 27px">
                    <div class="col-xs-12">
                        <asp:Label ID="Label2" runat="server" Text="Su solicitud de crédito se generó correctamente con el código:"
