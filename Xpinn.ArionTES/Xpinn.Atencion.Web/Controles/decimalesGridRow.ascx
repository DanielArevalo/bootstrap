...
<asp:TextBox ID="txtValor" runat="server" style="text-align: right" onblur = "Page_Load(this)" CssClass="form-control" 
    MaxLength="11" onprerender="txtValor_PreRender" Width="110px" ontextchanged="txtValor_TextChanged" AutoPostBack="True"
