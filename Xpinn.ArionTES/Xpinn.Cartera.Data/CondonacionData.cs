...
namespace Xpinn.Cartera.Data
{
    ...
    /// </summary>
    public class CondonacionData : GlobalData
    {
        ...
        public List<CondonacionInteres> ListarCredito(CondonacionInteres pCredito, Usuario pUsuario)
        {
            ...
            List<CondonacionInteres> lstCredito = new List<CondonacionInteres>();
            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(pUsuario))
            {
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    ...
                    {
                        BOExcepcion.Throw("CondonacionoData", "ListarCredito", ex);
                        return null;
                    }
                }
            }
            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(pUsuario))
            {
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        DbParameter pVALOR_COND_INT= cmdTransaccionFactory.CreateParameter();
                        pVALOR_COND_INT.ParameterName = "pintcorriente";
                        pVALOR_COND_INT.Value = pcondonacion.valorcond_intcte;

                        DbParameter pVALOR_COND_MORA = cmdTransaccionFactory.CreateParameter();
                        pVALOR_COND_MORA.ParameterName = "pintmora";
                        pVALOR_COND_MORA.Value = pcondonacion.valorcond_mora;
                        ...
                        cmdTransaccionFactory.Parameters.Add(pVALOR_COND_INT);
                        cmdTransaccionFactory.Parameters.Add(pVALOR_COND_MORA);
                        ...
                        cmdTransaccionFactory.CommandText = "USP_XPINN_CAR_CONDONACION";
                    ...
                    {
                        BOExcepcion.Throw("CondonacionoData", "CrearCondonacion", ex);
                        return null;
                    }
                }
            }
